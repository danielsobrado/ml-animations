import{r as n,j as e}from"./index-BPOBMoM_.js";import{C as l}from"./code-btky9Mp9.js";import{C as m}from"./check-9SU6wuHZ.js";import{C as p}from"./copy-co5PUF-e.js";function h(){const[i,s]=n.useState("sklearn"),[c,a]=n.useState(null),d=(t,r)=>{navigator.clipboard.writeText(t),a(r),setTimeout(()=>a(null),2e3)},o={sklearn:{title:"scikit-learn",description:"Most common library for traditional ML in Python",codes:[{title:"Bag of Words with CountVectorizer",code:`from sklearn.feature_extraction.text import CountVectorizer
