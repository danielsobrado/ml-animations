import{k as n,j as e}from"./react-vendor-Cdu38Wyn.js";import{N as l,D as m,S as p}from"./icons-CBDxh5OI.js";function x(){const[i,s]=n.useState("sklearn"),[c,a]=n.useState(null),d=(t,r)=>{navigator.clipboard.writeText(t),a(r),setTimeout(()=>a(null),2e3)},o={sklearn:{title:"scikit-learn",description:"Most common library for traditional ML in Python",codes:[{title:"Bag of Words with CountVectorizer",code:`from sklearn.feature_extraction.text import CountVectorizer
