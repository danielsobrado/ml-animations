import{a as v,j as e,k}from"./react-vendor-Cdu38Wyn.js";import{F as U,I as F,aZ as G,aQ as W,ar as X,$ as K,_ as Q}from"./icons-C7miCxLM.js";let H=1;function Y({userCode:r,testCode:l,timeoutMs:c=1200}){const n=H++;return new Promise(o=>{const s=new Worker(new URL("/ml-animations/assets/jsEvalWorker-BiN8n73y.js",import.meta.url),{type:"module"}),y=window.setTimeout(()=>{s.terminate(),o({ok:!1,results:[],error:"Execution timed out. Check for an infinite loop."})},c);s.onmessage=f=>{f.data.id===n&&(window.clearTimeout(y),s.terminate(),o({ok:f.data.ok,results:f.data.results||[],error:f.data.error}))},s.postMessage({id:n,userCode:r,testCode:l})})}function E(r,l){return l?"error":r!=null&&r.length?r.every(c=>c.passed)?"passed":"failed":"idle"}function J(r){return typeof r=="string"?r:JSON.stringify(r)}const $=/(\/\/.*|\/\*[\s\S]*?\*\/|(["'`])(?:\\.|(?!\2)[^\\])*\2|\b(?:const|let|var|function|return|if|else|for|while|new|throw|true|false|null|undefined)\b|\b\d+(?:\.\d+)?\b|\b[a-zA-Z_$][\w$]*(?=\s*\())/g;function _(r){const l=[];let c=0;for(const n of r.matchAll($)){n.index>c&&l.push(r.slice(c,n.index));const o=n[0];let s="plain";o.startsWith("//")||o.startsWith("/*")?s="comment":/^["'`]/.test(o)?s="string":/^\d/.test(o)?s="number":/^(const|let|var|function|return|if|else|for|while|new|throw|true|false|null|undefined)$/.test(o)?s="keyword":s="call",l.push(e.jsx("span",{className:`ua-code-token-${s}`,children:o},`${n.index}-${o}`)),c=n.index+o.length}return c<r.length&&l.push(r.slice(c)),l}function Z({exercises:r}){var B;const[l,c]=v.useState(0),n=r[l],o=v.useRef(null),[s,y]=v.useState(()=>Object.fromEntries(r.map(t=>[t.id,t.starterCode]))),[f,w]=v.useState({}),[C,N]=v.useState({}),[M,P]=v.useState(!1),[T,O]=v.useState(!1),j=s[n.id],a=C[n.id],A=E(a==null?void 0:a.results,a==null?void 0:a.error),S=f[n.id]||0,D=n.hints.slice(0,S),q=!!(a||S>0),z=v.useMemo(()=>{const t=[];return r.forEach((u,h)=>{const m=u.group||"Exercises",p=t[t.length-1];if((p==null?void 0:p.name)===m){p.items.push({exercise:u,index:h});return}t.push({name:m,items:[{exercise:u,index:h}]})}),t},[r]);async function I(){P(!0),O(!1);const t=await Y({userCode:j,testCode:n.testCode});N(u=>({...u,[n.id]:t})),P(!1)}function i(){y(t=>({...t,[n.id]:n.starterCode})),N(t=>({...t,[n.id]:null})),w(t=>({...t,[n.id]:0})),O(!1)}function d(){w(t=>({...t,[n.id]:Math.min(n.hints.length,S+1)}))}function g(){y(t=>({...t,[n.id]:n.solution})),O(!1)}function b(t){o.current&&(o.current.scrollTop=t.currentTarget.scrollTop,o.current.scrollLeft=t.currentTarget.scrollLeft)}const L=Object.values(C).filter(t=>{var u;return((u=t==null?void 0:t.results)==null?void 0:u.length)&&t.results.every(h=>h.passed)}).length;return e.jsxs("section",{className:"ua-codefix-lab",children:[e.jsxs("div",{className:"ua-codefix-head",children:[e.jsx("span",{children:"Code Completion-style lab"}),e.jsx("h2",{children:"Fix the TODOs, run the tests"}),e.jsx("p",{children:"Each exercise is almost complete. Change the smallest piece of code needed to make the tests pass."})]}),e.jsx("div",{className:"ua-codefix-progress",children:z.map(t=>{const u=t.items.filter(({exercise:h})=>{var p;const m=C[h.id];return((p=m==null?void 0:m.results)==null?void 0:p.length)&&m.results.every(R=>R.passed)}).length;return e.jsxs("div",{className:"ua-codefix-progress-group",children:[e.jsxs("div",{className:"ua-codefix-progress-label",children:[e.jsx("strong",{children:t.name}),e.jsxs("span",{children:[u,"/",t.items.length]})]}),e.jsx("div",{className:"ua-codefix-progress-steps",children:t.items.map(({exercise:h,index:m})=>{const p=C[h.id],R=E(p==null?void 0:p.results,p==null?void 0:p.error),V=R==="passed"?U:F;return e.jsxs("button",{type:"button",onClick:()=>{c(m),O(!1)},className:`ua-codefix-step ${m===l?"active":""} ${R}`,children:[e.jsx(V,{size:15,"aria-hidden":"true"}),e.jsxs("span",{children:[h.stepLabel||`${m+1}.`," ",h.title]})]},h.id)})})]},t.name)})}),e.jsxs("div",{className:"ua-codefix-grid",children:[e.jsxs("article",{className:"ua-codefix-card ua-codefix-instructions",children:[e.jsx("span",{children:n.difficulty}),e.jsx("h3",{children:n.title}),e.jsx("p",{children:n.objective}),e.jsxs("div",{className:"ua-codefix-concept",children:[e.jsx("strong",{children:"Concept"}),e.jsx("p",{children:n.concept})]}),e.jsxs("div",{className:"ua-codefix-explanation",children:[e.jsx("strong",{children:"After you pass"}),e.jsx("p",{children:n.explanation})]})]}),e.jsxs("article",{className:"ua-codefix-card ua-codefix-editor-card",children:[e.jsxs("div",{className:"ua-codefix-card-head",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Editor"}),e.jsx("h3",{children:"Complete the TODO"})]}),e.jsxs("button",{type:"button",onClick:i,children:[e.jsx(G,{size:14,"aria-hidden":"true"}),"Reset"]})]}),e.jsxs("div",{className:"ua-codefix-editor-shell",children:[e.jsx("pre",{className:"ua-codefix-highlight","aria-hidden":"true",ref:o,children:_(j)}),e.jsx("textarea",{className:"ua-codefix-editor",value:j,spellCheck:!1,"aria-label":`${n.title} code editor`,onScroll:b,onChange:t=>y(u=>({...u,[n.id]:t.target.value}))})]}),e.jsxs("div",{className:"ua-codefix-actions",children:[e.jsxs("button",{type:"button",onClick:I,disabled:M,children:[e.jsx(W,{size:15,"aria-hidden":"true"}),M?"Running...":"Run tests"]}),e.jsxs("button",{type:"button",onClick:d,disabled:S>=n.hints.length,children:[e.jsx(X,{size:15,"aria-hidden":"true"}),S===0?"Show hint":"Next hint"]}),e.jsxs("button",{type:"button",onClick:()=>O(t=>!t),disabled:!q,title:q?void 0:"Run tests or use a hint before revealing the solution.",children:[T?e.jsx(K,{size:15,"aria-hidden":"true"}):e.jsx(Q,{size:15,"aria-hidden":"true"}),T?"Hide solution":q?"See solution":"Try first"]})]})]}),e.jsxs("article",{className:"ua-codefix-card ua-codefix-feedback",children:[e.jsx("span",{children:"Checks"}),e.jsxs("h3",{children:[A==="passed"&&"All tests passed",A==="failed"&&"Keep going",A==="error"&&"Code error",A==="idle"&&"Run tests to begin"]}),(a==null?void 0:a.error)&&e.jsx("pre",{className:"ua-codefix-error",children:a.error}),((B=a==null?void 0:a.results)==null?void 0:B.length)>0?e.jsx("ul",{className:"ua-codefix-checks",children:a.results.map(t=>e.jsxs("li",{className:t.passed?"passed":"failed",children:[e.jsxs("strong",{children:[t.passed?"Pass":"Fail",": ",t.name]}),!t.passed&&e.jsxs("small",{children:["Expected ",J(t.expected),", got ",J(t.actual)]})]},t.name))}):e.jsx("p",{className:"ua-codefix-empty",children:"Run the tests. If one fails, use the smallest hint that helps."}),D.length>0&&e.jsxs("div",{className:"ua-codefix-hints",children:[e.jsx("strong",{children:"Hints"}),D.map((t,u)=>t.includes(`
`)?e.jsxs("div",{className:"ua-codefix-hint",children:[e.jsxs("b",{children:["Hint ",u+1,":"]}),e.jsx("pre",{className:"ua-codefix-hint-code",children:t})]},t):e.jsxs("p",{children:[e.jsxs("b",{children:["Hint ",u+1,":"]})," ",t]},t))]}),T&&e.jsxs("div",{className:"ua-codefix-solution",children:[e.jsx("strong",{children:"Solution"}),e.jsx("pre",{children:n.solution}),e.jsx("button",{type:"button",onClick:g,children:"Apply solution to editor"})]})]})]}),e.jsxs("div",{className:"ua-codefix-footer",children:[e.jsxs("strong",{children:[L," / ",r.length]}),e.jsx("span",{children:"exercises passed"})]})]})}const ee=[{id:"dot-product-first-pair",stepLabel:"1.1",group:"Dot product",title:"First matching pair",concept:"A dot product starts by multiplying entries with the same index.",objective:"Replace one number with the first pair product.",difficulty:"warmup",starterCode:`function firstPairProduct(a, b) {
...
return results;`,hints:["The chunks are already sorted by relevance.","Use the same budget check as greedy packing.","If it fits, push chunk.id and update used.",`if (used + chunk.tokens <= budget) {
  ...
  return packed;
}`,explanation:"Prompt packing balances relevance against token budget. The best chunk is not useful if it crowds out required evidence."},{id:"eval-true-positive",stepLabel:"62.1",group:"Confusion matrix",title:"True positive",concept:"A true positive happens when the model predicts positive and the true label is positive.",objective:"Return true only when prediction and label are both 1.",difficulty:"warmup",starterCode:`function isTruePositive(prediction, label) {
...
function populationStabilityIndex(referenceBins, currentBins) {
  ...
  return total;
}`,explanation:"PSI summarizes how much a binned distribution changed between reference and current data."}];function te(){return e.jsx(Z,{exercises:ee})}const ne=[[1,2],[3,1]],re=[[2,1,3],[1,4,2]],ae=[[4,9,7],[7,7,11]],x=[{row:0,col:0,hint:"Multiply Row 1 of A with Column 1 of B: (1×2) + (2×1)",answer:4},{row:0,col:1,hint:"Multiply Row 1 of A with Column 2 of B: (1×1) + (2×4)",answer:9},{row:0,col:2,hint:"Multiply Row 1 of A with Column 3 of B: (1×3) + (2×2)",answer:7},{row:1,col:0,hint:"Multiply Row 2 of A with Column 1 of B: (3×2) + (1×1)",answer:7},{row:1,col:1,hint:"Multiply Row 2 of A with Column 2 of B: (3×1) + (1×4)",answer:7},{row:1,col:2,hint:"Multiply Row 2 of A with Column 3 of B: (3×3) + (1×2)",answer:11}];function se(){const[r,l]=k.useState(0),[c,n]=k.useState(""),[o,s]=k.useState(""),[y,f]=k.useState(!1),[w,C]=k.useState(Array(6).fill(null)),[N,M]=k.useState(!1),[P,T]=k.useState(0),[O,j]=k.useState(0),a=x[r],A=()=>{const i=parseInt(c,10);if(j(d=>d+1),i===a.answer){s("✓ Correct!"),T(g=>g+1);const d=[...w];d[r]=i,C(d),setTimeout(()=>{r<x.length-1?(l(g=>g+1),n(""),s(""),f(!1)):(M(!0),s("🎉 Excellent! You completed all steps!"))},1e3)}else s("✗ Not quite. Try again or ask for a hint.")},S=()=>{f(!0)},D=()=>{l(0),n(""),s(""),f(!1),C(Array(6).fill(null)),M(!1),T(0),j(0)},q=i=>{i.key==="Enter"&&c.trim()!==""&&A()},z=i=>r<x.length&&x[r].row===i,I=i=>r<x.length&&x[r].col===i;return e.jsxs("div",{className:"flex flex-col items-center p-3 h-full",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-2",children:"Practice Exercise"}),e.jsxs("div",{className:"bg-white rounded-lg shadow-lg p-4 w-full",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 flex-wrap",children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"A"}),e.jsx("div",{className:"grid grid-cols-2 gap-1",children:ne.map((i,d)=>i.map((g,b)=>e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded ${z(d)?"bg-blue-300 scale-110 ring-2 ring-blue-500":"bg-blue-400"} transition-all`,children:g},`a-${d}-${b}`)))})]}),e.jsx("span",{className:"text-2xl font-bold mx-2",children:"×"}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"B"}),e.jsx("div",{className:"grid grid-cols-3 gap-1",children:re.map((i,d)=>i.map((g,b)=>e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded ${I(b)?"bg-green-300 scale-110 ring-2 ring-green-500":"bg-green-400"} transition-all`,children:g},`b-${d}-${b}`)))})]}),e.jsx("span",{className:"text-2xl font-bold mx-2",children:"="}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"C"}),e.jsx("div",{className:"grid grid-cols-3 gap-1",children:ae.map((i,d)=>i.map((g,b)=>{const L=d*3+b,B=r===L,t=w[L]!==null;return e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded transition-all ${B?"bg-yellow-300 ring-2 ring-yellow-500 scale-110":t?"bg-orange-400":"bg-orange-200"}`,children:t?w[L]:"?"},`r-${d}-${b}`)}))})]})]}),e.jsxs("div",{className:"mt-4 text-center",children:[e.jsxs("p",{className:"text-gray-700 font-medium",children:["Step ",r+1," of ",x.length,": Calculate C[",a.row+1,"][",a.col+1,"]"]}),e.jsxs("p",{className:"text-sm text-gray-700 mt-1",children:["Row ",a.row+1," of A × Column ",a.col+1," of B"]})]})]}),N?e.jsx("div",{className:"mt-4 w-full max-w-sm text-center",children:e.jsxs("div",{className:"p-4 bg-green-100 rounded-lg border border-green-300",children:[e.jsx("p",{className:"text-green-700 font-bold text-lg",children:"🎉 Congratulations!"}),e.jsxs("p",{className:"text-green-600 mt-2",children:["Score: ",P," / ",x.length," correct"]}),e.jsxs("p",{className:"text-sm",children:["Total attempts: ",O]})]})}):e.jsxs("div",{className:"mt-4 w-full max-w-sm",children:[e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"number",value:c,onChange:i=>n(i.target.value),onKeyPress:q,placeholder:"Your answer...",className:"flex-1 px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none text-center text-lg font-bold"}),e.jsx("button",{onClick:A,disabled:c.trim()==="",className:"px-4 py-2 bg-green-500 hover:bg-green-600 disabled:bg-gray-400 text-white font-bold rounded-lg transition-colors",children:"Submit"})]}),e.jsx("button",{onClick:S,className:"mt-2 w-full px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-lg transition-colors",children:"💡 Show Hint"}),y&&e.jsx("div",{className:"mt-2 p-3 bg-yellow-100 rounded-lg border border-yellow-300",children:e.jsx("p",{className:"text-sm",children:a.hint})}),o&&e.jsx("div",{className:`mt-2 p-3 rounded-lg text-center font-bold ${o.includes("✓")?"bg-green-100 text-green-700":"bg-red-100 text-red-700"}`,children:o})]}),e.jsxs("div",{className:"mt-4 flex items-center gap-4",children:[e.jsxs("div",{className:"text-sm text-gray-800",children:["Progress: ",w.filter(i=>i!==null).length," / ",x.length]}),e.jsx("button",{onClick:D,className:"px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-bold rounded-lg transition-colors text-sm",children:"↺ Reset"})]}),e.jsx("div",{className:"mt-8 w-full",children:e.jsx(te,{})})]})}export{se as default};
