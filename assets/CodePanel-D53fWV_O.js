import{k as s,j as e}from"./react-vendor-Cdu38Wyn.js";import{X as m,b9 as p,C as g,l as u,N as x,D as b,S as f}from"./icons-CBDxh5OI.js";function h(){const[t,n]=s.useState("load"),[a,r]=s.useState(null),d=(i,o)=>{navigator.clipboard.writeText(i),r(o),setTimeout(()=>r(null),2e3)},l=[{id:"load",label:"Load GloVe",icon:m},{id:"use",label:"Use Embeddings",icon:p},{id:"train",label:"Train Custom",icon:g},{id:"visualize",label:"Visualization",icon:u}],c={load:[{title:"Load Pre-trained GloVe (Manual)",code:`import numpy as np
