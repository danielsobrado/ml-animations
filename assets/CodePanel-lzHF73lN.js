import{r as n,j as e}from"./index-C0KvVCDn.js";import{C as l}from"./code-Tg4DfYSz.js";import{C as m}from"./check-KjlvtcW8.js";import{C as p}from"./copy-BpYaIKBv.js";function h(){const[i,s]=n.useState("sklearn"),[c,a]=n.useState(null),d=(t,r)=>{navigator.clipboard.writeText(t),a(r),setTimeout(()=>a(null),2e3)},o={sklearn:{title:"scikit-learn",description:"Most common library for traditional ML in Python",codes:[{title:"Bag of Words with CountVectorizer",code:`from sklearn.feature_extraction.text import CountVectorizer
