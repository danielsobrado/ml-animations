import{k as s,j as e}from"./react-vendor-Cdu38Wyn.js";import{R as m,aO as p,C as g,k as u,I as x,x as b,M as f}from"./icons-C72kWQca.js";function h(){const[t,n]=s.useState("load"),[a,r]=s.useState(null),d=(i,o)=>{navigator.clipboard.writeText(i),r(o),setTimeout(()=>r(null),2e3)},l=[{id:"load",label:"Load GloVe",icon:m},{id:"use",label:"Use Embeddings",icon:p},{id:"train",label:"Train Custom",icon:g},{id:"visualize",label:"Visualization",icon:u}],c={load:[{title:"Load Pre-trained GloVe (Manual)",code:`import numpy as np
