import{a as v,j as e,k as y}from"./react-vendor-Cdu38Wyn.js";import{F as V,I as X,aZ as F,aQ as Q,ar as H,$,_ as Y}from"./icons-C7miCxLM.js";let _=1;function G({userCode:r,testCode:u,timeoutMs:c=1200}){const o=_++;return new Promise(a=>{const s=new Worker(new URL("/ml-animations/assets/jsEvalWorker-BiN8n73y.js",import.meta.url),{type:"module"}),w=window.setTimeout(()=>{s.terminate(),a({ok:!1,results:[],error:"Execution timed out. Check for an infinite loop."})},c);s.onmessage=f=>{f.data.id===o&&(window.clearTimeout(w),s.terminate(),a({ok:f.data.ok,results:f.data.results||[],error:f.data.error}))},s.postMessage({id:o,userCode:r,testCode:u})})}function I(r,u){return u?"error":r!=null&&r.length?r.every(c=>c.passed)?"passed":"failed":"idle"}function z(r){return typeof r=="string"?r:JSON.stringify(r)}const Z=/(\/\/.*|\/\*[\s\S]*?\*\/|(["'`])(?:\\.|(?!\2)[^\\])*\2|\b(?:const|let|var|function|return|if|else|for|while|new|throw|true|false|null|undefined)\b|\b\d+(?:\.\d+)?\b|\b[a-zA-Z_$][\w$]*(?=\s*\())/g;function K(r){const u=[];let c=0;for(const o of r.matchAll(Z)){o.index>c&&u.push(r.slice(c,o.index));const a=o[0];let s="plain";a.startsWith("//")||a.startsWith("/*")?s="comment":/^["'`]/.test(a)?s="string":/^\d/.test(a)?s="number":/^(const|let|var|function|return|if|else|for|while|new|throw|true|false|null|undefined)$/.test(a)?s="keyword":s="call",u.push(e.jsx("span",{className:`ua-code-token-${s}`,children:a},`${o.index}-${a}`)),c=o.index+a.length}return c<r.length&&u.push(r.slice(c)),u}function W({exercises:r}){var R;const[u,c]=v.useState(0),o=r[u],a=v.useRef(null),[s,w]=v.useState(()=>Object.fromEntries(r.map(t=>[t.id,t.starterCode]))),[f,A]=v.useState({}),[j,B]=v.useState({}),[q,E]=v.useState(!1),[S,k]=v.useState(!1),T=s[o.id],n=j[o.id],C=I(n==null?void 0:n.results,n==null?void 0:n.error),O=f[o.id]||0,L=o.hints.slice(0,O),M=!!(n||O>0),P=v.useMemo(()=>{const t=[];return r.forEach((l,p)=>{const m=l.group||"Exercises",h=t[t.length-1];if((h==null?void 0:h.name)===m){h.items.push({exercise:l,index:p});return}t.push({name:m,items:[{exercise:l,index:p}]})}),t},[r]);async function J(){E(!0),k(!1);const t=await G({userCode:T,testCode:o.testCode});B(l=>({...l,[o.id]:t})),E(!1)}function i(){w(t=>({...t,[o.id]:o.starterCode})),B(t=>({...t,[o.id]:null})),A(t=>({...t,[o.id]:0})),k(!1)}function d(){A(t=>({...t,[o.id]:Math.min(o.hints.length,O+1)}))}function x(){w(t=>({...t,[o.id]:o.solution})),k(!1)}function b(t){a.current&&(a.current.scrollTop=t.currentTarget.scrollTop,a.current.scrollLeft=t.currentTarget.scrollLeft)}const N=Object.values(j).filter(t=>{var l;return((l=t==null?void 0:t.results)==null?void 0:l.length)&&t.results.every(p=>p.passed)}).length;return e.jsxs("section",{className:"ua-codefix-lab",children:[e.jsxs("div",{className:"ua-codefix-head",children:[e.jsx("span",{children:"Code Completion-style lab"}),e.jsx("h2",{children:"Fix the TODOs, run the tests"}),e.jsx("p",{children:"Each exercise is almost complete. Change the smallest piece of code needed to make the tests pass."})]}),e.jsx("div",{className:"ua-codefix-progress",children:P.map(t=>{const l=t.items.filter(({exercise:p})=>{var h;const m=j[p.id];return((h=m==null?void 0:m.results)==null?void 0:h.length)&&m.results.every(D=>D.passed)}).length;return e.jsxs("div",{className:"ua-codefix-progress-group",children:[e.jsxs("div",{className:"ua-codefix-progress-label",children:[e.jsx("strong",{children:t.name}),e.jsxs("span",{children:[l,"/",t.items.length]})]}),e.jsx("div",{className:"ua-codefix-progress-steps",children:t.items.map(({exercise:p,index:m})=>{const h=j[p.id],D=I(h==null?void 0:h.results,h==null?void 0:h.error),U=D==="passed"?V:X;return e.jsxs("button",{type:"button",onClick:()=>{c(m),k(!1)},className:`ua-codefix-step ${m===u?"active":""} ${D}`,children:[e.jsx(U,{size:15,"aria-hidden":"true"}),e.jsxs("span",{children:[p.stepLabel||`${m+1}.`," ",p.title]})]},p.id)})})]},t.name)})}),e.jsxs("div",{className:"ua-codefix-grid",children:[e.jsxs("article",{className:"ua-codefix-card ua-codefix-instructions",children:[e.jsx("span",{children:o.difficulty}),e.jsx("h3",{children:o.title}),e.jsx("p",{children:o.objective}),e.jsxs("div",{className:"ua-codefix-concept",children:[e.jsx("strong",{children:"Concept"}),e.jsx("p",{children:o.concept})]}),e.jsxs("div",{className:"ua-codefix-explanation",children:[e.jsx("strong",{children:"After you pass"}),e.jsx("p",{children:o.explanation})]})]}),e.jsxs("article",{className:"ua-codefix-card ua-codefix-editor-card",children:[e.jsxs("div",{className:"ua-codefix-card-head",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Editor"}),e.jsx("h3",{children:"Complete the TODO"})]}),e.jsxs("button",{type:"button",onClick:i,children:[e.jsx(F,{size:14,"aria-hidden":"true"}),"Reset"]})]}),e.jsxs("div",{className:"ua-codefix-editor-shell",children:[e.jsx("pre",{className:"ua-codefix-highlight","aria-hidden":"true",ref:a,children:K(T)}),e.jsx("textarea",{className:"ua-codefix-editor",value:T,spellCheck:!1,"aria-label":`${o.title} code editor`,onScroll:b,onChange:t=>w(l=>({...l,[o.id]:t.target.value}))})]}),e.jsxs("div",{className:"ua-codefix-actions",children:[e.jsxs("button",{type:"button",onClick:J,disabled:q,children:[e.jsx(Q,{size:15,"aria-hidden":"true"}),q?"Running...":"Run tests"]}),e.jsxs("button",{type:"button",onClick:d,disabled:O>=o.hints.length,children:[e.jsx(H,{size:15,"aria-hidden":"true"}),O===0?"Show hint":"Next hint"]}),e.jsxs("button",{type:"button",onClick:()=>k(t=>!t),disabled:!M,title:M?void 0:"Run tests or use a hint before revealing the solution.",children:[S?e.jsx($,{size:15,"aria-hidden":"true"}):e.jsx(Y,{size:15,"aria-hidden":"true"}),S?"Hide solution":M?"See solution":"Try first"]})]})]}),e.jsxs("article",{className:"ua-codefix-card ua-codefix-feedback",children:[e.jsx("span",{children:"Checks"}),e.jsxs("h3",{children:[C==="passed"&&"All tests passed",C==="failed"&&"Keep going",C==="error"&&"Code error",C==="idle"&&"Run tests to begin"]}),(n==null?void 0:n.error)&&e.jsx("pre",{className:"ua-codefix-error",children:n.error}),((R=n==null?void 0:n.results)==null?void 0:R.length)>0?e.jsx("ul",{className:"ua-codefix-checks",children:n.results.map(t=>e.jsxs("li",{className:t.passed?"passed":"failed",children:[e.jsxs("strong",{children:[t.passed?"Pass":"Fail",": ",t.name]}),!t.passed&&e.jsxs("small",{children:["Expected ",z(t.expected),", got ",z(t.actual)]})]},t.name))}):e.jsx("p",{className:"ua-codefix-empty",children:"Run the tests. If one fails, use the smallest hint that helps."}),L.length>0&&e.jsxs("div",{className:"ua-codefix-hints",children:[e.jsx("strong",{children:"Hints"}),L.map((t,l)=>t.includes(`
`)?e.jsxs("div",{className:"ua-codefix-hint",children:[e.jsxs("b",{children:["Hint ",l+1,":"]}),e.jsx("pre",{className:"ua-codefix-hint-code",children:t})]},t):e.jsxs("p",{children:[e.jsxs("b",{children:["Hint ",l+1,":"]})," ",t]},t))]}),S&&e.jsxs("div",{className:"ua-codefix-solution",children:[e.jsx("strong",{children:"Solution"}),e.jsx("pre",{children:o.solution}),e.jsx("button",{type:"button",onClick:x,children:"Apply solution to editor"})]})]})]}),e.jsxs("div",{className:"ua-codefix-footer",children:[e.jsxs("strong",{children:[N," / ",r.length]}),e.jsx("span",{children:"exercises passed"})]})]})}const ee=[{id:"dot-product-first-pair",stepLabel:"1.1",group:"Dot product",title:"First matching pair",concept:"A dot product starts by multiplying entries with the same index.",objective:"Replace one number with the first pair product.",difficulty:"warmup",starterCode:`function firstPairProduct(a, b) {
...
return results;`,hints:["Frobenius error squares every entry difference.","The difference is already stored in diff.","total += diff * diff;"],solution:`function frobeniusErrorSquared(A, Ahat) {
  ...
  return total;
}`,explanation:"Low-rank approximation keeps the most important patterns and measures what was lost with reconstruction error."}];function te(){return e.jsx(W,{exercises:ee})}const oe=[[1,2],[3,1]],re=[[2,1,3],[1,4,2]],ne=[[4,9,7],[7,7,11]],g=[{row:0,col:0,hint:"Multiply Row 1 of A with Column 1 of B: (1×2) + (2×1)",answer:4},{row:0,col:1,hint:"Multiply Row 1 of A with Column 2 of B: (1×1) + (2×4)",answer:9},{row:0,col:2,hint:"Multiply Row 1 of A with Column 3 of B: (1×3) + (2×2)",answer:7},{row:1,col:0,hint:"Multiply Row 2 of A with Column 1 of B: (3×2) + (1×1)",answer:7},{row:1,col:1,hint:"Multiply Row 2 of A with Column 2 of B: (3×1) + (1×4)",answer:7},{row:1,col:2,hint:"Multiply Row 2 of A with Column 3 of B: (3×3) + (1×2)",answer:11}];function se(){const[r,u]=y.useState(0),[c,o]=y.useState(""),[a,s]=y.useState(""),[w,f]=y.useState(!1),[A,j]=y.useState(Array(6).fill(null)),[B,q]=y.useState(!1),[E,S]=y.useState(0),[k,T]=y.useState(0),n=g[r],C=()=>{const i=parseInt(c,10);if(T(d=>d+1),i===n.answer){s("✓ Correct!"),S(x=>x+1);const d=[...A];d[r]=i,j(d),setTimeout(()=>{r<g.length-1?(u(x=>x+1),o(""),s(""),f(!1)):(q(!0),s("🎉 Excellent! You completed all steps!"))},1e3)}else s("✗ Not quite. Try again or ask for a hint.")},O=()=>{f(!0)},L=()=>{u(0),o(""),s(""),f(!1),j(Array(6).fill(null)),q(!1),S(0),T(0)},M=i=>{i.key==="Enter"&&c.trim()!==""&&C()},P=i=>r<g.length&&g[r].row===i,J=i=>r<g.length&&g[r].col===i;return e.jsxs("div",{className:"flex flex-col items-center p-3 h-full",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-2",children:"Practice Exercise"}),e.jsxs("div",{className:"bg-white rounded-lg shadow-lg p-4 w-full",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 flex-wrap",children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"A"}),e.jsx("div",{className:"grid grid-cols-2 gap-1",children:oe.map((i,d)=>i.map((x,b)=>e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded ${P(d)?"bg-blue-300 scale-110 ring-2 ring-blue-500":"bg-blue-400"} transition-all`,children:x},`a-${d}-${b}`)))})]}),e.jsx("span",{className:"text-2xl font-bold mx-2",children:"×"}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"B"}),e.jsx("div",{className:"grid grid-cols-3 gap-1",children:re.map((i,d)=>i.map((x,b)=>e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded ${J(b)?"bg-green-300 scale-110 ring-2 ring-green-500":"bg-green-400"} transition-all`,children:x},`b-${d}-${b}`)))})]}),e.jsx("span",{className:"text-2xl font-bold mx-2",children:"="}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-lg font-bold mb-1",children:"C"}),e.jsx("div",{className:"grid grid-cols-3 gap-1",children:ne.map((i,d)=>i.map((x,b)=>{const N=d*3+b,R=r===N,t=A[N]!==null;return e.jsx("div",{className:`w-10 h-10 flex items-center justify-center font-bold text-black rounded transition-all ${R?"bg-yellow-300 ring-2 ring-yellow-500 scale-110":t?"bg-orange-400":"bg-orange-200"}`,children:t?A[N]:"?"},`r-${d}-${b}`)}))})]})]}),e.jsxs("div",{className:"mt-4 text-center",children:[e.jsxs("p",{className:"text-gray-700 font-medium",children:["Step ",r+1," of ",g.length,": Calculate C[",n.row+1,"][",n.col+1,"]"]}),e.jsxs("p",{className:"text-sm text-gray-700 mt-1",children:["Row ",n.row+1," of A × Column ",n.col+1," of B"]})]})]}),B?e.jsx("div",{className:"mt-4 w-full max-w-sm text-center",children:e.jsxs("div",{className:"p-4 bg-green-100 rounded-lg border border-green-300",children:[e.jsx("p",{className:"text-green-700 font-bold text-lg",children:"🎉 Congratulations!"}),e.jsxs("p",{className:"text-green-600 mt-2",children:["Score: ",E," / ",g.length," correct"]}),e.jsxs("p",{className:"text-sm",children:["Total attempts: ",k]})]})}):e.jsxs("div",{className:"mt-4 w-full max-w-sm",children:[e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"number",value:c,onChange:i=>o(i.target.value),onKeyPress:M,placeholder:"Your answer...",className:"flex-1 px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none text-center text-lg font-bold"}),e.jsx("button",{onClick:C,disabled:c.trim()==="",className:"px-4 py-2 bg-green-500 hover:bg-green-600 disabled:bg-gray-400 text-white font-bold rounded-lg transition-colors",children:"Submit"})]}),e.jsx("button",{onClick:O,className:"mt-2 w-full px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-lg transition-colors",children:"💡 Show Hint"}),w&&e.jsx("div",{className:"mt-2 p-3 bg-yellow-100 rounded-lg border border-yellow-300",children:e.jsx("p",{className:"text-sm",children:n.hint})}),a&&e.jsx("div",{className:`mt-2 p-3 rounded-lg text-center font-bold ${a.includes("✓")?"bg-green-100 text-green-700":"bg-red-100 text-red-700"}`,children:a})]}),e.jsxs("div",{className:"mt-4 flex items-center gap-4",children:[e.jsxs("div",{className:"text-sm text-gray-800",children:["Progress: ",A.filter(i=>i!==null).length," / ",g.length]}),e.jsx("button",{onClick:L,className:"px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-bold rounded-lg transition-colors text-sm",children:"↺ Reset"})]}),e.jsx("div",{className:"mt-8 w-full",children:e.jsx(te,{})})]})}export{se as default};
