import{L as e}from"./AlgebraCodeLab-DVU9BymP.js";import{A as x,g as v}from"./AlgebraCodeLab-DVU9BymP.js";import"./index-HC-jm2co.js";import"./react-vendor-Cdu38Wyn.js";import"./router-D1rsdnJA.js";import"./icons-C7miCxLM.js";import"./assessment-data-KPydSR8a.js";import"./glossary-data-CUftlhbd.js";import"./CodeFixLab-D78XXQhT.js";import"./codeLabProgress-DZ-sE7n4.js";const t=[{id:"gd-prediction-error",stepLabel:"26.1",group:"Gradient descent least squares",title:"Prediction error",concept:"Gradient descent updates parameters using prediction error.",objective:"Return prediction minus target.",difficulty:"warmup",starterCode:`function predictionError(prediction, target) {
...
return results;`,hints:["Use adjustmentSet.includes(confounders[i]).","If one is missing, return false.","if (!adjustmentSet.includes(confounders[i])) return false;"],solution:`function coversConfounders(adjustmentSet, confounders) {
  ...
  return true;
}`,explanation:"This toy check is not full d-separation, but it reinforces the adjustment-set idea."}],g=[...e,...t,...n,...a,...r,...i,...o];export{g as ALGEBRA_CODE_LABS,x as ALGEBRA_CODE_LAB_GROUPS_BY_LESSON,v as getAlgebraCodeLabsForLesson};
