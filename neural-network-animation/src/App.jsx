      ...
      <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-700 shadow-xl">
        <div className="flex items-center justify-between px-4 py-3 bg-gray-800 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-400 text-sm font-mono">{snippet.file}</span>
          </div>
          <a
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className={`ml-auto text-gray-500 transition-transform duration-300 ${isSelected ? 'rotate-180' : ''}`}>
            ▼
          </span>
        </div>
        {isSelected && (
          <div className="text-gray-300 text-sm mt-3 space-y-1 animate-fadeIn">
        ...
        {activeTab === 'visualize' && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-gray-700">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div>
                    <label className="text-gray-400 text-xs block mb-1">Input (XOR)</label>
                    <select
                  ...
                  {loss !== null && (
                    <div className="text-center">
                      <label className="text-gray-400 text-xs block mb-1">Loss</label>
                  ...
                  <div className="text-center">
                    <label className="text-gray-400 text-xs block mb-1">Epoch</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                <h3 className="text-lg font-bold text-orange-400 mb-2">⬅️ Backward Pass</h3>
                <div className="text-gray-300 text-sm font-mono space-y-1">
            ...
            <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 rounded-xl p-6 border border-green-700/50">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  ...
                  <div className="text-gray-400 text-sm">XOR Accuracy</div>
                </div>
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <div className="text-3xl font-bold text-blue-400">84.3%</div>
                  <div className="text-gray-400 text-sm">Titanic Accuracy</div>
                </div>
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <div className="text-3xl font-bold text-purple-400">993</div>
                  <div className="text-gray-400 text-sm">Parameters</div>
                </div>
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <div className="text-3xl font-bold text-yellow-400">0</div>
                  <div className="text-gray-400 text-sm">ML Frameworks</div>
                </div>
              </div>
            </div>
          </div>
