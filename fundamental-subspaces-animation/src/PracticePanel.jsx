...
function MatrixMiniTable() {
  return (
    <div className="grid gap-2 rounded-lg border border-slate-200 bg-white p-3 text-sm shadow-sm dark:border-slate-700 dark:bg-slate-900 md:grid-cols-4">
      {MATCHING.map((item) => (
        <div key={item.label} className="rounded-lg bg-slate-100 p-3 dark:bg-slate-800">
          <p className="font-mono font-bold text-slate-950 dark:text-white">{item.label}</p>
...
export default function PracticePanel() {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-5 p-4 text-slate-900 dark:text-slate-100">
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <div className="mb-4 flex items-start justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-100 text-amber-700 transition hover:bg-amber-200 dark:bg-amber-950 dark:text-amber-200"
            title="Show hint"
          >
            <HelpCircle size={18} />
          </button>
        ...
        {complete && (
          <div className="mt-5 rounded-lg border border-indigo-200 bg-indigo-50 p-4 text-center text-indigo-900 dark:border-indigo-800 dark:bg-indigo-950 dark:text-indigo-100">
