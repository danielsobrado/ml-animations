  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-emerald-400 mb-2">Bidirectional Attention</h2>
      ...
      <div className="bg-black/30 rounded-xl p-4">
        <div className="text-sm text-gray-400 mb-3">Select a token to see what it attends to:</div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-blue-500/10 rounded-xl p-6 border border-blue-500/30">
          ...
          <div className="bg-black/40 rounded-lg p-4 mb-4">
            <div className="font-mono text-xs text-gray-400 mb-2">Attention Mask:</div>
                  ...
                  {tokens.map((_, j) => (
                    <div
                      ...
                      className={`w-full aspect-square rounded flex items-center justify-center ${
                        j <= i ? 'bg-blue-500/50 text-white' : 'bg-gray-800 text-gray-600'
                      }`}
                    >
                      {j <= i ? '1' : '0'}
                    </div>
      ...
      <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-xl p-6 border border-emerald-500/30">
        <h3 className="font-semibold text-emerald-400 mb-4">🎯 Why Bidirectional Matters for SD3</h3>
        ...
        <div className="space-y-4">
          <div className="bg-black/30 rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="text-gray-300">
                <span className="text-blue-400">CLIP (causal):</span> When processing "LEFT", 
                it hasn't seen "blue cube" yet. Harder to understand the spatial relationship.
              </div>
              <div className="text-gray-300">
                <span className="text-emerald-400">T5 (bidirectional):</span> "LEFT" can attend to 
          ...
          <div className="bg-black/30 rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="text-gray-300">
                <span className="text-blue-400">CLIP:</span> "dog" is encoded before seeing "but a cat", 
                potentially missing the negation context.
              </div>
              <div className="text-gray-300">
                <span className="text-emerald-400">T5:</span> "dog" sees the full context including "not" 
      ...
      <div className="bg-teal-500/10 rounded-xl p-6 border border-teal-500/30">
        <h3 className="font-semibold text-teal-400 mb-3">📍 Relative Position Bias</h3>
        <div className="text-gray-300 text-sm space-y-2">
          ...
          <div className="bg-black/40 rounded p-4 font-mono text-xs">
            ...
            <span className="text-teal-400">where B = learned_bias(pos_i - pos_j)</span>
          </div>
          <p>
