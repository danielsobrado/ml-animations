  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-emerald-400 mb-2">What is T5?</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-emerald-500/10 rounded-xl p-4 text-center border border-emerald-500/30">
          <div className="text-2xl font-bold text-emerald-400">4.7B</div>
        ...
        <div className="bg-cyan-500/10 rounded-xl p-4 text-center border border-cyan-500/30">
          <div className="text-2xl font-bold text-cyan-400">4096</div>
          <div className="text-sm text-gray-400">Hidden Dimension</div>
        </div>
      ...
      <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-xl p-6 border border-emerald-500/30">
        <h3 className="text-lg font-semibold text-emerald-400 mb-3">🔍 SD3 Uses Encoder Only</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-black/30 rounded-lg p-4">
            <div className="font-semibold text-emerald-400 mb-2">Full T5 (Encoder-Decoder)</div>
          ...
          <div className="bg-black/30 rounded-lg p-4">
            <div className="font-semibold text-teal-400 mb-2">T5 in SD3 (Encoder Only)</div>
            <div className="text-sm text-gray-300 space-y-1">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-emerald-500/10 rounded-lg p-4 border border-emerald-500/30">
          ...
          <h4 className="font-semibold text-emerald-400 mb-1">Long Context</h4>
        ...
        <div className="bg-teal-500/10 rounded-lg p-4 border border-teal-500/30">
          <Zap className="text-teal-400 mb-2" size={24} />
          <h4 className="font-semibold text-teal-400 mb-1">Deep Understanding</h4>
          <p className="text-sm text-gray-300">
            Bidirectional attention captures context from both directions for better comprehension.
          </p>
        </div>
        <div className="bg-cyan-500/10 rounded-lg p-4 border border-cyan-500/30">
          <HardDrive className="text-cyan-400 mb-2" size={24} />
          <h4 className="font-semibold text-cyan-400 mb-1">Optional Component</h4>
          <p className="text-sm text-gray-300">
