    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Euler Scheduler: <span className="text-fuchsia-400">ODE Solvers</span>
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {Object.entries(solvers).map(([key, s]) => (
          ...
          >
            ...
            <code className="text-xs text-gray-500 block overflow-x-auto">{s.formula}</code>
          </button>
        ))}
      </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex items-center gap-4 px-4">
          <span className="text-sm text-gray-400 w-20">Steps: {numSteps}</span>
          <input
            type="range"
            min="4"
            max="30"
        ...
        <div className="text-center mt-4 text-lg">
          Step <span className="text-fuchsia-400 font-bold">{step}</span> / {numSteps}
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="bg-black/30 rounded-lg p-4 font-mono text-sm space-y-2">
              ...
              <p><span className="text-blue-400">x</span> = sample_noise()</p>
              <p><span className="text-blue-400">dt</span> = 1.0 / num_steps</p>
              <p className="text-gray-400 mt-2"># Iterate</p>
              <p><span className="text-purple-400">for</span> t <span className="text-purple-400">in</span> linspace(0, 1, num_steps):</p>
              <p className="pl-4"><span className="text-blue-400">v</span> = model(x, t)</p>
              <p className="pl-4"><span className="text-blue-400">x</span> = x + v * dt</p>
              <p className="text-gray-400 mt-2"># x is now the generated sample</p>
            </div>
          </div>
          <div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="py-3 px-4 text-left text-gray-400">Solver</th>
                <th className="py-3 px-4 text-left text-gray-400">Order</th>
                <th className="py-3 px-4 text-left text-gray-400">NFE/step</th>
                <th className="py-3 px-4 text-left text-gray-400">Error (O)</th>
                <th className="py-3 px-4 text-left text-gray-400">Best For</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              <tr>
                <td className="py-3 px-4 text-fuchsia-400">Euler</td>
              ...
              <tr>
                <td className="py-3 px-4 text-purple-400">Heun</td>
              ...
              <tr>
                <td className="py-3 px-4 text-blue-400">DPM++</td>
                <td className="py-3 px-4">2nd+</td>
