    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Sigma Schedules: <span className="text-fuchsia-400">Noise Level Control</span>
        </h2>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              The <strong className="text-fuchsia-400">shape of this curve</strong> affects 
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex items-center gap-4 px-4">
          <span className="text-sm text-gray-400 w-32">Sampling Steps: {numSteps}</span>
          <input
            type="range"
            min="5"
            max="50"
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {Object.entries(schedules).map(([key, schedule]) => (
          ...
          >
            ...
            <code className="text-xs text-gray-400 block mb-2">{schedule.formula}</code>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="py-3 px-4 text-left text-gray-400">Schedule</th>
                <th className="py-3 px-4 text-left text-gray-400">Pros</th>
                <th className="py-3 px-4 text-left text-gray-400">Cons</th>
                <th className="py-3 px-4 text-left text-gray-400">Best For</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              <tr>
                <td className="py-3 px-4 text-fuchsia-400">Linear</td>
              ...
              <tr>
                <td className="py-3 px-4 text-purple-400">Cosine</td>
              ...
              <tr>
                <td className="py-3 px-4 text-blue-400">Karras</td>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="bg-black/30 rounded-lg p-4 font-mono text-center">
              ...
              <p className="text-sm text-gray-400 mt-2">where α(t) = √(1 - σ²(t))</p>
            </div>
          </div>
          <div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white/5 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-400">Linear or Karras (configurable)</p>
          </div>
          <div className="bg-white/5 rounded-lg p-4">
            <h4 className="font-bold text-purple-300 mb-2">Steps</h4>
            <p className="text-sm text-gray-400">28-50 typical (quality/speed tradeoff)</p>
          </div>
          <div className="bg-white/5 rounded-lg p-4">
            <h4 className="font-bold text-blue-300 mb-2">Sigma Range</h4>
            <p className="text-sm text-gray-400">σ_max=14.6, σ_min=0.0292</p>
          </div>
        </div>
      </div>
    </div>
