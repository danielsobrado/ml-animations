    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          The Flow: <span className="text-fuchsia-400">Probability Transport</span>
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex items-center gap-4 px-4">
          <span className="text-sm text-gray-400 w-12">t = 0</span>
          <input
            type="range"
            min="0"
            max="1"
          ...
          />
          <span className="text-sm text-gray-400 w-12">t = 1</span>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {Object.entries(paths).map(([key, path]) => (
            ...
            >
              ...
              <code className="text-sm text-gray-400 block mb-2">{path.formula}</code>
