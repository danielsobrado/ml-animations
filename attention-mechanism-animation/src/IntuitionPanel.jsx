            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-white mb-4">
                        What is Attention? <span className="gradient-text">The Core Intuition</span>
                    </h2>
                    <p className="text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
                        Attention is like a <strong className="text-amber-400">spotlight</strong> that helps the model 
                ...
                <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-2xl p-6 mb-8 border border-amber-500/30">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-amber-400 mb-2">The Database Analogy</h3>
                            ...
                            <p className="mt-3 text-slate-400 text-sm italic">
                                Unlike a hard lookup that returns one exact match, attention returns a <strong className="text-white">weighted combination</strong> of all values!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700">
                                ...
                                {currentScenario.items.map((item) => (
                                    <div 
                                        ...
                                        className={`flex items-center justify-between p-3 rounded-lg transition-all duration-300 ${
                                            highlightedWord === item.id ? 'ring-2 ring-white' : ''
                                        } ${
                    ...
                    {Object.keys(attentionWeights).length === currentScenario.items.length && (
                        <div className="mt-6 p-4 bg-purple-500/20 rounded-xl border border-purple-500/30 animate-fadeIn">
                            <div className="flex items-start gap-3">
                                <div className="bg-purple-500 p-2 rounded-lg">
                                    <ArrowRight className="text-white" size={20} />
                                </div>
                                <div>
                                    <h4 className="font-bold text-purple-400 mb-1">Result: Weighted Combination</h4>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4">
                    <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 text-center">
                        ...
                        <h4 className="font-bold text-white mb-1">Step 1</h4>
                        <p className="text-slate-400 text-sm">Compute Q·K similarity scores</p>
                    </div>
                    <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 text-center">
                        <div className="text-3xl mb-2">📊</div>
                        <h4 className="font-bold text-white mb-1">Step 2</h4>
                        <p className="text-slate-400 text-sm">Apply softmax for weights</p>
                    </div>
                    <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 text-center">
                        <div className="text-3xl mb-2">✨</div>
                        <h4 className="font-bold text-white mb-1">Step 3</h4>
                        <p className="text-slate-400 text-sm">Weighted sum of Values</p>
                    </div>
                </div>

                {/* Why Attention Matters */}
                <div className="mt-8 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl p-6 border border-green-500/20">
                    <h3 className="text-xl font-bold text-green-400 mb-4">💡 Why is Attention Revolutionary?</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <h4 className="font-medium text-white">Before Attention (RNNs):</h4>
                        ...
                        <div className="space-y-2">
                            <h4 className="font-medium text-white">With Attention:</h4>
