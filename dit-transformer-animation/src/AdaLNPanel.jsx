  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          <span className="text-pink-400">AdaLN-Zero</span>: Adaptive Layer Normalization
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="mb-8">
          <label className="text-sm text-gray-400 block mb-2">
            Timestep t: <span className="text-pink-400 font-bold">{timestep}</span> / 1000
          </label>
          <input
            type="range"
            min="0"
        ...
        <div className="bg-black/30 rounded-xl p-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-400">timestep + class/text</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-400">Learn parameters</p>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-black/30 rounded-xl p-5 border border-white/10">
          <h3 className="font-bold text-pink-400 mb-3">🎯 Why Not Cross-Attention?</h3>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-amber-900/20 rounded-xl p-4 border border-amber-500/30">
            <h4 className="font-bold text-amber-400 mb-2">⏱️ Timestep t</h4>
          ...
          <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/30">
            <h4 className="font-bold text-purple-400 mb-2">🏷️ Class Label y</h4>
            <p className="text-sm text-gray-400">
          ...
          <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
            <h4 className="font-bold text-blue-400 mb-2">📝 Pooled Text (SD3)</h4>
            <p className="text-sm text-gray-400">
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="bg-black/50 rounded-lg p-4 font-mono text-sm overflow-x-auto">
          <pre className="text-gray-300">{`class AdaLayerNorm(nn.Module):
    ...
    def forward(self, x, c):
      ...
      <div className="bg-gradient-to-r from-pink-900/30 to-orange-900/30 rounded-xl p-6 border border-pink-500/30">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <p className="text-sm text-gray-400 mb-2">Standard LayerNorm:</p>
            <div className="bg-black/30 p-3 rounded-lg font-mono text-sm">
              y = γ × norm(x) + β
            </div>
            <p className="text-xs text-gray-500 mt-2">γ, β are learned parameters (same for all inputs)</p>
          </div>
          <div>
            <p className="text-sm text-gray-400 mb-2">Adaptive LayerNorm:</p>
            <div className="bg-black/30 p-3 rounded-lg font-mono text-sm">
              y = <span className="text-pink-400">γ(c)</span> × norm(x) + <span className="text-blue-400">β(c)</span>
            </div>
            <p className="text-xs text-gray-500 mt-2">γ(c), β(c) are functions of conditioning c</p>
          </div>
        </div>
      </div>
    </div>
