    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          <span className="text-pink-400">Block</span> Structure
        </h2>
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <div className="text-center mb-4">
              ...
              <ArrowDown className="mx-auto mt-2 text-gray-500" />
            </div>
            ...
            <div className="relative border-2 border-dashed border-pink-500/30 rounded-xl p-4 mx-auto max-w-md">
              {current.residual && (
                <div className="absolute -left-8 top-1/2 -translate-y-1/2 w-6 h-32 border-l-2 border-t-2 border-b-2 border-pink-400/50 rounded-l-lg">
                  <span className="absolute -left-6 top-1/2 -translate-y-1/2 text-pink-400 text-xs">+</span>
                </div>
              )}
              ...
              {current.separate ? (
                ...
                <div className="flex gap-4">
                  <div className="flex-1 space-y-3">
                    <p className="text-xs text-blue-400 text-center mb-2">Image Stream</p>
                  ...
                  <div className="flex-1 space-y-3">
                    <p className="text-xs text-orange-400 text-center mb-2">Text Stream</p>
              ...
              {current.gated && (
                <div className="absolute -right-20 top-1/2 -translate-y-1/2 text-xs text-pink-400">
                  ×α (gate)
                </div>
              )}
            </div>
            ...
            <div className="text-center mt-4">
              <ArrowDown className="mx-auto mb-2 text-gray-500" />
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="py-3 px-4 text-left text-gray-400">Feature</th>
                <th className="py-3 px-4 text-left text-gray-400">Standard ViT</th>
                <th className="py-3 px-4 text-left text-gray-400">DiT</th>
                <th className="py-3 px-4 text-left text-gray-400">MM-DiT</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              <tr>
                ...
                <td className="py-3 px-4 text-pink-400">AdaLN</td>
                <td className="py-3 px-4 text-pink-400">AdaLN (separate)</td>
              </tr>
              <tr>
                <td className="py-3 px-4">Conditioning</td>
                <td className="py-3 px-4">None (class token)</td>
                <td className="py-3 px-4 text-pink-400">Via AdaLN</td>
                <td className="py-3 px-4 text-pink-400">Via AdaLN + Joint Attn</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="py-3 px-4">1 (shared)</td>
                <td className="py-3 px-4 text-cyan-400">2 (separate)</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="bg-black/50 rounded-lg p-4 font-mono text-sm overflow-x-auto">
          <pre className="text-gray-300">{`class DiTBlock(nn.Module):
