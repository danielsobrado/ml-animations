    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Text Encoding: <span className="text-fuchsia-400">Triple Encoder Power</span>
        </h2>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              how text relates to images (trained on image-text pairs). <strong className="text-purple-400">T5</strong> provides 
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {Object.entries(encoders).map(([key, enc]) => (
          ...
          >
            ...
            <p className="text-sm text-gray-400">{enc.role}</p>
          </button>
        ))}
      </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400">{encoders[selectedEncoder].description}</p>
          </div>
        </div>

        <div className="grid md:grid-cols-4 gap-4">
          <div className="bg-white/5 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-fuchsia-400">{encoders[selectedEncoder].params}</p>
            <p className="text-sm text-gray-400">Parameters</p>
          </div>
          <div className="bg-white/5 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-purple-400">{encoders[selectedEncoder].dim}</p>
            <p className="text-sm text-gray-400">Embedding Dim</p>
          </div>
          <div className="bg-white/5 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-blue-400">{encoders[selectedEncoder].maxTokens}</p>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400">Input Prompt</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400">Tokenized</p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-fuchsia-500/30 to-purple-500/30 rounded-lg px-4 py-3 mb-2">
              ...
              <p className="text-xs text-gray-400">+ Pooled vectors</p>
            </div>
            <p className="text-xs text-gray-400">→ MMDiT</p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                ...
                <th className="py-3 px-4 text-left text-purple-400">T5-XXL</th>
              </tr>
            </thead>
