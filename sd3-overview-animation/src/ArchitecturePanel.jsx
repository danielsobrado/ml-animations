    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          SD3 Architecture: <span className="text-fuchsia-400">The Complete System</span>
        </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-3xl font-bold text-fuchsia-400">8B</p>
          <p className="text-sm text-gray-400">Parameters (largest)</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-3xl font-bold text-purple-400">3</p>
          <p className="text-sm text-gray-400">Text Encoders</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-3xl font-bold text-blue-400">1024²</p>
          <p className="text-sm text-gray-400">Max Resolution</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-3xl font-bold text-green-400">28-50</p>
          <p className="text-sm text-gray-400">Typical Steps</p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400">Random Noise</p>
              </div>
              <ArrowRight className="text-gray-500" />
              <ComponentBox
                id="mmdit"
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400">128×128×16</p>
              </div>
              <ArrowRight className="text-gray-500" />
              <ComponentBox
                id="vae_dec"
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400">1024×1024 RGB</p>
              </div>
            </div>
          </div>
        ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <div className="flex flex-col gap-2 items-center">
                ...
                <p className="text-xs text-gray-500">Target Image</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="bg-white/5 rounded-lg p-3 text-center">
                <p className="text-xs text-gray-400">Text Embeddings</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center">
                <p className="text-xs text-gray-400">x₁ (clean latent)</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center">
                <p className="text-xs text-gray-400">x₀ ~ N(0,I)</p>
              </div>
            </div>
