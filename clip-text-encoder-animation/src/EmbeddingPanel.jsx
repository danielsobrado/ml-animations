  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-blue-400 mb-2">CLIP Embeddings & Outputs</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-blue-500/10 rounded-xl p-6 border border-blue-500/30">
          ...
          <div className="space-y-3 text-sm text-gray-300">
            <p>
              <strong>Shape:</strong> <code className="text-blue-400">[batch, 77, 768]</code>
            </p>
            <p>
            ...
            <div className="bg-black/40 rounded p-3 mt-2">
              <span className="text-blue-400 font-semibold">Used for:</span> Joint attention with image tokens.
      ...
      <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/30">
        <h3 className="font-semibold text-purple-400 mb-4">How SD3 Combines Both CLIPs</h3>
        
        <div className="space-y-4">
          <div className="bg-black/30 rounded-lg p-4">
            <h4 className="text-blue-400 font-semibold mb-2">Sequence Embeddings (for Joint Attention)</h4>
            <div className="font-mono text-sm text-gray-300">
              CLIP-L: [1, 77, 768]<br />
              CLIP-G: [1, 77, 1280]<br />
              <span className="text-purple-400">Concatenated → [1, 77, 2048]</span>
            </div>
          </div>
          ...
          <div className="bg-black/30 rounded-lg p-4">
            ...
            <div className="font-mono text-sm text-gray-300">
              ...
              <span className="text-gray-500">Then projected to match DiT hidden size</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-black/30 rounded-xl p-6">
        <h3 className="font-semibold text-gray-300 mb-4">📊 Dimension Summary</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-left py-2 px-3 text-gray-400">Stage</th>
                <th className="text-left py-2 px-3 text-gray-400">Shape</th>
