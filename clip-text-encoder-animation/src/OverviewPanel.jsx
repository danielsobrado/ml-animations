  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-blue-400 mb-2">What is CLIP?</h2>
      ...
      <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl p-6 border border-blue-500/30">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-black/30 rounded-lg p-4">
            <div className="font-semibold text-purple-400 mb-2">CLIP-L/14 (Large)</div>
          ...
          <div className="bg-black/30 rounded-lg p-4">
            <div className="font-semibold text-pink-400 mb-2">CLIP-G/14 (Giant)</div>
            <ul className="text-sm text-gray-300 space-y-1">
              <li>• 77 max tokens</li>
      ...
      <div className="bg-black/30 rounded-lg p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-blue-400 font-semibold">{steps[step].title}</span>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-blue-500/10 rounded-lg p-4 border border-blue-500/30">
          ...
          <h4 className="font-semibold text-blue-400 mb-1">Text Only</h4>
        ...
        <div className="bg-purple-500/10 rounded-lg p-4 border border-purple-500/30">
          ...
          <h4 className="font-semibold text-purple-400 mb-1">Contrastive Training</h4>
          <p className="text-sm text-gray-300">
        ...
        <div className="bg-pink-500/10 rounded-lg p-4 border border-pink-500/30">
          <Link2 className="text-pink-400 mb-2" size={24} />
          <h4 className="font-semibold text-pink-400 mb-1">Pooled + Sequence</h4>
          <p className="text-sm text-gray-300">
