  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-blue-400 mb-2">CLIP vs T5: Why Both?</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-xl p-6 border border-blue-500/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-blue-400 text-xl">CLIP</h3>
              <p className="text-sm text-gray-400">Contrastive Language-Image Pre-training</p>
            </div>
          </div>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300">Visual-aligned embeddings</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="text-green-400" size={16} />
              <span className="text-gray-300">Fast inference</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="text-green-400" size={16} />
              <span className="text-gray-300">Good compositional understanding</span>
            </div>
            <div className="flex items-center gap-2">
              <X className="text-red-400" size={16} />
              <span className="text-gray-300">Limited to 77 tokens</span>
            </div>
            <div className="flex items-center gap-2">
              <X className="text-red-400" size={16} />
              <span className="text-gray-300">Causal attention only</span>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-green-500/20 to-teal-500/20 rounded-xl p-6 border border-green-500/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-green-400 text-xl">T5-XXL</h3>
              <p className="text-sm text-gray-400">Text-to-Text Transfer Transformer</p>
            </div>
          </div>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-2">
              <Check className="text-green-400" size={16} />
              <span className="text-gray-300">Deep language understanding</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="text-green-400" size={16} />
              <span className="text-gray-300">Bidirectional attention</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="text-green-400" size={16} />
              <span className="text-gray-300">Long context (256+ tokens)</span>
            </div>
            <div className="flex items-center gap-2">
              <X className="text-red-400" size={16} />
              <span className="text-gray-300">No visual training</span>
            </div>
            <div className="flex items-center gap-2">
              <X className="text-red-400" size={16} />
              <span className="text-gray-300">Very slow (4.7B params)</span>
            </div>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10 bg-black/20">
                ...
                <th className="text-left py-3 px-4 text-blue-400">CLIP</th>
                <th className="text-left py-3 px-4 text-green-400">T5</th>
                <th className="text-left py-3 px-4 text-gray-400">Better</th>
              </tr>
            </thead>
            <tbody>
              {comparisons.map((comp, i) => (
                ...
                >
                  <td className="py-3 px-4 text-gray-300 font-medium">{comp.feature}</td>
                  <td className="py-3 px-4 text-gray-300">{comp.clip}</td>
                  <td className="py-3 px-4 text-gray-300">{comp.t5}</td>
                  <td className="py-3 px-4">
                    {comp.winner === 'clip' && <span className="text-blue-400 font-semibold">CLIP</span>}
                    {comp.winner === 't5' && <span className="text-green-400 font-semibold">T5</span>}
                    {comp.winner === 'both' && <span className="text-purple-400 font-semibold">Both!</span>}
                  </td>
                </tr>
              ))}
            </tbody>
      ...
      <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-green-500/10 rounded-xl p-6 border border-purple-500/30">
        <h3 className="font-semibold text-purple-400 mb-4">🔍 Key Architecture Difference: Attention</h3>
        
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-black/30 rounded-lg p-4">
            <h4 className="text-blue-400 font-semibold mb-3">CLIP: Causal Attention</h4>
            <div className="font-mono text-xs bg-black/40 rounded p-3 mb-3">
              Token sees: [itself, previous tokens]<br/>
              <span className="text-gray-500">├─ cat: sees [BOS, a, cat]</span><br/>
              <span className="text-gray-500">├─ on: sees [BOS, a, cat, on]</span><br/>
              <span className="text-gray-500">└─ EOS: sees [ALL tokens]</span>
            </div>
          ...
          <div className="bg-black/30 rounded-lg p-4">
            ...
            <div className="font-mono text-xs bg-black/40 rounded p-3 mb-3">
              ...
              <span className="text-gray-500">├─ cat: sees [a, cat, on, mat]</span><br/>
              <span className="text-gray-500">├─ on: sees [a, cat, on, mat]</span><br/>
              <span className="text-gray-500">└─ mat: sees [a, cat, on, mat]</span>
            </div>
            <p className="text-sm text-gray-400">
      ...
      <div className="bg-black/40 rounded-xl p-6">
        <h3 className="font-semibold text-gray-300 mb-4">🎯 Why SD3 Uses Both Encoders</h3>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-4 bg-blue-500/10 rounded-lg">
            ...
            <div>
              <h4 className="text-blue-400 font-semibold">Visual Grounding (CLIP)</h4>
          ...
          <div className="flex items-start gap-4 p-4 bg-purple-500/10 rounded-lg">
            ...
            <div>
              <h4 className="text-purple-400 font-semibold">Complementary Strengths</h4>
              <p className="text-sm text-gray-300">
