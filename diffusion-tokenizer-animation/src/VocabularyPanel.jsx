  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-orange-400 mb-2">Understanding Vocabulary</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-blue-500/10 rounded-xl p-4 text-center border border-blue-500/30">
          <div className="text-2xl font-bold text-blue-400">49,408</div>
          <div className="text-sm text-gray-400">CLIP Vocab Size</div>
        </div>
        <div className="bg-green-500/10 rounded-xl p-4 text-center border border-green-500/30">
          ...
          <div className="text-sm text-gray-400">T5 Vocab Size</div>
        </div>
        <div className="bg-purple-500/10 rounded-xl p-4 text-center border border-purple-500/30">
          <div className="text-2xl font-bold text-purple-400">2</div>
          <div className="text-sm text-gray-400">Special Tokens</div>
        </div>
        <div className="bg-orange-500/10 rounded-xl p-4 text-center border border-orange-500/30">
          ...
          <div className="text-sm text-gray-400">Subword Tokens</div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <label className="flex items-center gap-2 px-4 py-2 bg-black/30 rounded-lg cursor-pointer">
          ...
          />
          <span className="text-gray-300 text-sm">Show special tokens</span>
        </label>
      </div>
                ...
                <tr key={i} className="border-b border-white/5 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4">
                    <span className={`px-2 py-1 rounded-full text-xs ${
                      ...
                      entry.type === 'subword' ? 'bg-blue-500/20 text-blue-400' :
                      'bg-gray-500/20 text-gray-400'
                    }`}>
                      {entry.type}
                    </span>
                  </td>
                  <td className="py-3 px-4 text-gray-400">{entry.desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-xl p-6 border border-green-500/30">
          ...
          <div className="space-y-3 text-sm text-gray-300">
            ...
            <div className="bg-black/30 rounded p-3">
              <code className="text-blue-400">photo</code><br/>
      ...
      <div className="bg-yellow-500/10 rounded-xl p-6 border border-yellow-500/30">
        ...
        <div className="text-gray-300 space-y-2 text-sm">
          ...
          <div className="bg-black/40 rounded p-4 font-mono text-sm">
            <div className="text-gray-400"># "photorealistic sunset"</div>
            <div className="text-white">["photo", "realistic&lt;/w&gt;", "sunset&lt;/w&gt;"]</div>
            <br/>
            <div className="text-gray-400"># Meaning:</div>
            <div className="text-blue-400">"photo" → continues to next token</div>
      ...
      <div className="bg-black/30 rounded-xl p-6">
        <h3 className="font-semibold text-gray-300 mb-4">🔬 Try These Prompts</h3>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="bg-black/40 rounded p-4">
            <div className="text-orange-400 mb-2">"a cat"</div>
          ...
          <div className="bg-black/40 rounded p-4">
            <div className="text-orange-400 mb-2">"photorealistic sunset"</div>
            <div className="text-gray-300">
