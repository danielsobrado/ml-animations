  ...
  const renderStepVisual = () => {
    ...
    switch (step.visual) {
      case 'text':
        return (
          <div className="text-center p-8">
            <div className="text-sm text-gray-400 mb-2">Raw Text Input</div>
      ...
      case 'preprocess':
        return (
          <div className="text-center p-8">
            <div className="text-sm text-gray-400 mb-2">After Preprocessing</div>
            <div className="text-2xl text-orange-300 font-mono bg-black/40 px-6 py-4 rounded-lg inline-block">
              "{step.data}"
            </div>
            <div className="mt-2 text-xs text-gray-500">Converted to lowercase</div>
          </div>
        );
      ...
      case 'tokens':
        return (
          <div className="text-center p-6">
            <div className="text-sm text-gray-400 mb-4">BPE Tokens</div>
      ...
      case 'special':
        return (
          <div className="text-center p-6">
            <div className="text-sm text-gray-400 mb-4">With Special Tokens</div>
            <div className="flex flex-wrap justify-center gap-2">
              {step.data.map((token, i) => (
      ...
      case 'ids':
        return (
          <div className="text-center p-6">
            <div className="text-sm text-gray-400 mb-4">Token IDs</div>
            <div className="flex flex-wrap justify-center gap-2">
              {step.data.map((id, i) => (
      ...
      case 'padded':
        return (
          <div className="text-center p-6">
            <div className="text-sm text-gray-400 mb-4">Padded Sequence (77 tokens)</div>
            <div className="flex flex-wrap justify-center gap-1">
              ...
              <span className="px-2 py-1 rounded text-xs font-mono bg-gray-500/30 text-gray-400">
      ...
      case 'final':
        return (
          <div className="text-center p-8">
            <div className="text-sm text-gray-400 mb-4">Ready for Text Encoder</div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-orange-400 mb-2">Tokenization Pipeline</h2>
      ...
      <div className="bg-black/40 rounded-xl p-6">
        <h3 className="text-gray-300 font-semibold mb-4">Complete Pipeline Code</h3>
