  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-orange-400 mb-2">Practice Lab</h2>
        <p className="text-gray-300">Test your understanding of diffusion model tokenization</p>
      </div>
      ...
      <div className="flex justify-center gap-4">
        <button
          ...
          className={`px-6 py-3 rounded-xl font-semibold transition-all ${
            !showExercise ? 'bg-orange-500 text-white' : 'bg-black/30 text-gray-400 hover:text-white'
          }`}
        >
          Quiz
        </button>
          ...
          {!isComplete ? (
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-orange-400 font-semibold">Score: {score}/{questions.length}</span>
              </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-4xl font-bold text-orange-400 mb-4">{score} / {questions.length}</p>
