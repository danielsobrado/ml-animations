  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-orange-400 mb-2">CLIP vs T5 Tokenization</h2>
      ...
      <div className="bg-black/40 rounded-xl p-4 text-center">
        <div className="text-gray-400 text-sm mb-1">Input Text</div>
      ...
      <div ref={containerRef} className={`bg-gradient-to-r ${
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-gray-400 text-sm">{active.tokens.length} tokens</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {active.tokens.map((token, i) => (
            <div key={i} className={`token-item flex flex-col items-center px-3 py-2 rounded-lg ${
              ...
              <span className="text-xs text-gray-500 mt-1">{active.ids[i]}</span>
            </div>
          ))}
        </div>
      ...
      <div className="bg-black/40 rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            <tr className="border-b border-white/5">
              <td className="py-3 px-4 text-gray-300">Start Token</td>
              <td className="py-3 px-4"><code className="text-blue-400 bg-blue-500/20 px-2 py-1 rounded">&lt;|startoftext|&gt;</code></td>
              <td className="py-3 px-4"><span className="text-gray-500">None (implicit)</span></td>
            </tr>
            <tr className="border-b border-white/5">
              <td className="py-3 px-4 text-gray-300">End Token</td>
              <td className="py-3 px-4"><code className="text-blue-400 bg-blue-500/20 px-2 py-1 rounded">&lt;|endoftext|&gt;</code></td>
              <td className="py-3 px-4"><code className="text-green-400 bg-green-500/20 px-2 py-1 rounded">&lt;/s&gt;</code></td>
            </tr>
            <tr className="border-b border-white/5">
              <td className="py-3 px-4 text-gray-300">Case</td>
      ...
      <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/30">
        <h3 className="font-semibold text-purple-400 mb-3">Why Use Both?</h3>
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="bg-black/30 rounded-lg p-4">
            <div className="text-blue-400 font-medium mb-1">CLIP</div>
          ...
          <div className="bg-black/30 rounded-lg p-4">
            <div className="text-purple-400 font-medium mb-1">Together</div>
            <div className="text-gray-300">
