    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-400">Teaching the model about word order</p>
            </div>

            {/* Explanation */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                <h3 className="text-xl font-semibold text-emerald-400">Why Positional Encoding?</h3>
            ...
            {/* Visualization */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                <h3 className="text-xl font-semibold text-emerald-400">Positional Embedding Visualization</h3>
                <canvas
                    ref={canvasRef}
                    width={600}
                    height={120}
                ...
                <div className="bg-gray-900 p-4 rounded">
                    <div className="text-sm text-gray-400">Selected Position: <span className="text-emerald-400 font-mono">{selectedPos}</span></div>
                    <div className="text-sm text-gray-400">Embedding Dimension: <span className="text-emerald-400 font-mono">{embeddingDim}</span></div>
                </div>
            </div>

            {/* Formula */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                <h3 className="text-xl font-semibold text-emerald-400">How It Works</h3>
                <div className="bg-gray-900 p-4 rounded space-y-2">
                    <div className="font-mono text-sm text-gray-300">
                        <div>Token Embedding: <span className="text-blue-400">E_token</span> (768-dim)</div>
                        <div>Position Embedding: <span className="text-yellow-400">E_pos</span> (768-dim)</div>
                        <div className="mt-2 text-emerald-400">Final Input: E_token + E_pos</div>
                    </div>
                </div>
