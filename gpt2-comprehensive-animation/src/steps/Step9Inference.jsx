    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-400">Making generation fast</p>
            </div>

            {/* KV Cache Explanation */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                <h3 className="text-xl font-semibold text-emerald-400">KV Caching</h3>
                ...
                <div className="flex flex-col gap-4 mt-4">
                    ...
                    <div className="bg-gray-900 p-4 rounded border border-red-900/30">
                        ...
                        <div className="mt-1 text-xs text-gray-400">Recomputes attention for "The", "cat", "sat"</div>
                    </div>

                    {/* With Cache */}
                    <div className="bg-gray-900 p-4 rounded border border-emerald-900/30">
                        <div className="text-emerald-400 font-bold text-sm mb-2">With Cache (O(N) complexity)</div>
                        <div className="flex gap-1 text-xs font-mono text-gray-500">
                            <span className="bg-gray-800 px-1 rounded text-gray-400 border border-emerald-500/50">The</span>
                            <span className="bg-gray-800 px-1 rounded text-gray-400 border border-emerald-500/50">cat</span>
                            <span className="bg-gray-800 px-1 rounded text-gray-400 border border-emerald-500/50">sat</span>
                            <span className="bg-emerald-600 px-1 rounded text-white">on</span>
                        </div>
                        <div className="mt-1 text-xs text-gray-400">Uses cached K/V for "The", "cat", "sat". Only computes "on".</div>
                    </div>
                </div>
            </div>
            ...
            {/* Sampling Strategies */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                <h3 className="text-xl font-semibold text-emerald-400">Sampling Strategies</h3>
                <p className="text-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-900 p-4 rounded">
                        ...
                        <div className="text-xs text-gray-400">Always pick the highest probability token. Can be repetitive.</div>
                    </div>
                    <div className="bg-gray-900 p-4 rounded">
                        <div className="font-bold text-white mb-1">Top-k</div>
                        <div className="text-xs text-gray-400">Sample from the top <em>k</em> most likely tokens.</div>
                    </div>
                    <div className="bg-gray-900 p-4 rounded">
                        <div className="font-bold text-white mb-1">Nucleus (Top-p)</div>
                        <div className="text-xs text-gray-400">Sample from the smallest set of tokens whose cumulative probability exceeds <em>p</em>.</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-emerald-900 bg-opacity-30 border border-emerald-700 rounded-lg p-8 text-center space-y-4 mt-8">
                <h2 className="text-3xl font-bold text-emerald-400">🎉 Course Complete!</h2>
                <p className="text-gray-300">
