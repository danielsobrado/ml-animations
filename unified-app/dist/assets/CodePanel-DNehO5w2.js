import{r as n,j as e}from"./index-quAWpIA7.js";import{C as l}from"./code-BC671jUr.js";import{C as m}from"./check-BCWxNOQQ.js";import{C as p}from"./copy-DK9VVZ-c.js";function h(){const[i,s]=n.useState("sklearn"),[c,a]=n.useState(null),d=(t,r)=>{navigator.clipboard.writeText(t),a(r),setTimeout(()=>a(null),2e3)},o={sklearn:{title:"scikit-learn",description:"Most common library for traditional ML in Python",codes:[{title:"Bag of Words with CountVectorizer",code:`from sklearn.feature_extraction.text import CountVectorizer
...
print("\\nDocument Similarity:")
print(sim.round(3))`}]}};return e.jsxs("div",{className:"space-y-6 pb-20",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("h2",{className:"text-3xl font-bold mb-2",children:[e.jsx("span",{className:"text-purple-600 dark:text-purple-400",children:"Python"})," Code Examples"]}),e.jsx("p",{className:"text-gray-800 dark:text-gray-400",children:"Implement BoW and TF-IDF with popular libraries"})]}),e.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:Object.entries(o).map(([t,r])=>e.jsx("button",{onClick:()=>s(t),className:`px-4 py-2 rounded-lg transition-all ${i===t?"bg-purple-600 text-white":"bg-white/10 text-gray-800 dark:text-gray-400 hover:text-white"}`,children:r.title},t))}),e.jsx("div",{className:"text-center text-gray-800 dark:text-sm",children:o[i].description}),e.jsx("div",{className:"space-y-6",children:o[i].codes.map((t,r)=>e.jsxs("div",{className:"bg-black/40 rounded-xl border border-white/10 overflow-hidden",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-2 bg-white/5 border-b border-white/10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(l,{size:16,className:"text-purple-600 dark:text-purple-400"}),e.jsx("span",{className:"font-medium text-white",children:t.title})]}),e.jsx("button",{onClick:()=>d(t.code,r),className:"flex items-center gap-1 px-2 py-1 text-sm text-gray-800 dark:text-gray-400 hover:text-white transition-colors",children:c===r?e.jsxs(e.Fragment,{children:[e.jsx(m,{size:14,className:"text-green-400"}),e.jsx("span",{className:"text-green-400",children:"Copied!"})]}):e.jsxs(e.Fragment,{children:[e.jsx(p,{size:14}),"Copy"]})})]}),e.jsx("pre",{className:"p-4 overflow-x-auto text-sm",children:e.jsx("code",{className:"text-green-300",children:t.code})})]},r))}),e.jsxs("div",{className:"bg-gradient-to-r from-purple-900/20 to-blue-900/20 rounded-xl p-6 border border-purple-500/30",children:[e.jsx("h4",{className:"font-bold text-purple-600 dark:text-purple-400 mb-4",children:"📦 Quick Install Commands"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-800 dark:text-gray-400 mb-2",children:"scikit-learn"}),e.jsx("code",{className:"text-sm",children:"pip install scikit-learn"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-800 dark:text-gray-400 mb-2",children:"NLTK"}),e.jsx("code",{className:"text-sm",children:"pip install nltk"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-800 dark:text-gray-400 mb-2",children:"spaCy"}),e.jsx("code",{className:"text-sm",children:"pip install spacy && python -m spacy download en_core_web_sm"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-800 dark:text-gray-400 mb-2",children:"All dependencies"}),e.jsx("code",{className:"text-sm",children:"pip install numpy pandas scikit-learn nltk spacy"})]})]})]})]})}export{h as default};
