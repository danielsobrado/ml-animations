import{r as a,j as e}from"./index-CsxpOLHd.js";import{C as m}from"./code-CB4Crw6s.js";import{C as c}from"./check-DG0zwD5h.js";import{C as p}from"./copy-Bahzg9gk.js";function f(){const[s,n]=a.useState("gensim"),[d,r]=a.useState(null),l=(t,o)=>{navigator.clipboard.writeText(t),r(o),setTimeout(()=>r(null),2e3)},i={gensim:{title:"Gensim",description:"Most popular library for Word2Vec in Python",codes:[{title:"Train Word2Vec from Scratch",code:`from gensim.models import Word2Vec
...
def cluster_words(model, words, n_clusters=5):
    ...
    return clustered`}]}};return e.jsxs("div",{className:"space-y-6 pb-20",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("h2",{className:"text-3xl font-bold mb-2",children:[e.jsx("span",{className:"text-cyan-400",children:"Python"})," Code Examples"]}),e.jsx("p",{className:"text-gray-400",children:"Implement and use Word2Vec with popular libraries"})]}),e.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:Object.entries(i).map(([t,o])=>e.jsx("button",{onClick:()=>n(t),className:`px-4 py-2 rounded-lg transition-all ${s===t?"bg-cyan-600 text-white":"bg-white/10 text-gray-400 hover:text-white"}`,children:o.title},t))}),e.jsx("div",{className:"text-center text-gray-400 text-sm",children:i[s].description}),e.jsx("div",{className:"space-y-6",children:i[s].codes.map((t,o)=>e.jsxs("div",{className:"bg-black/40 rounded-xl border border-white/10 overflow-hidden",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-2 bg-white/5 border-b border-white/10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(m,{size:16,className:"text-cyan-400"}),e.jsx("span",{className:"font-medium text-white",children:t.title})]}),e.jsx("button",{onClick:()=>l(t.code,o),className:"flex items-center gap-1 px-2 py-1 text-sm text-gray-400 hover:text-white transition-colors",children:d===o?e.jsxs(e.Fragment,{children:[e.jsx(c,{size:14,className:"text-green-400"}),e.jsx("span",{className:"text-green-400",children:"Copied!"})]}):e.jsxs(e.Fragment,{children:[e.jsx(p,{size:14}),"Copy"]})})]}),e.jsx("pre",{className:"p-4 overflow-x-auto text-sm",children:e.jsx("code",{className:"text-green-300",children:t.code})})]},o))}),e.jsxs("div",{className:"bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-xl p-6 border border-cyan-500/30",children:[e.jsx("h4",{className:"font-bold text-cyan-400 mb-4",children:"📦 Quick Install Commands"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-400 mb-2",children:"Gensim (recommended)"}),e.jsx("code",{className:"text-green-300 text-sm",children:"pip install gensim"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-400 mb-2",children:"TensorFlow"}),e.jsx("code",{className:"text-green-300 text-sm",children:"pip install tensorflow"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-400 mb-2",children:"PyTorch"}),e.jsx("code",{className:"text-green-300 text-sm",children:"pip install torch"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-sm text-gray-400 mb-2",children:"Visualization"}),e.jsx("code",{className:"text-green-300 text-sm",children:"pip install matplotlib scikit-learn"})]})]})]})]})}export{f as default};
