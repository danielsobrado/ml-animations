import{c as m,r as a,j as e,C as p}from"./index-quAWpIA7.js";import{S as g}from"./search-P0ah77zD.js";import{B as x}from"./bar-chart-NgSFFPhz.js";import{C as u}from"./code-BC671jUr.js";import{C as b}from"./check-BCWxNOQQ.js";import{C as f}from"./copy-DK9VVZ-c.js";/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=m("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);function N(){const[r,n]=a.useState("load"),[s,o]=a.useState(null),d=(i,t)=>{navigator.clipboard.writeText(i),o(t),setTimeout(()=>o(null),2e3)},l=[{id:"load",label:"Load GloVe",icon:v},{id:"use",label:"Use Embeddings",icon:g},{id:"train",label:"Train Custom",icon:p},{id:"visualize",label:"Visualization",icon:x}],c={load:[{title:"Load Pre-trained GloVe (Manual)",code:`import numpy as np
...
visualize_analogy('king', 'queen', 'man', 'woman', glove)`}]};return e.jsxs("div",{className:"space-y-6 pb-20",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("h2",{className:"text-3xl font-bold mb-2",children:[e.jsx("span",{className:"gradient-text",children:"Python"})," Code Examples"]}),e.jsx("p",{className:"text-gray-800 dark:text-gray-400",children:"Load, use, and train GloVe embeddings"})]}),e.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:l.map(i=>{const t=i.icon;return e.jsxs("button",{onClick:()=>n(i.id),className:`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${r===i.id?"bg-violet-600 text-white":"bg-white/10 text-gray-800 dark:text-gray-400 hover:bg-white/20"}`,children:[e.jsx(t,{size:16}),i.label]},i.id)})}),e.jsx("div",{className:"space-y-6",children:c[r].map((i,t)=>e.jsxs("div",{className:"bg-black/30 rounded-xl border border-white/10 overflow-hidden",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-3 bg-white/5 border-b border-white/10",children:[e.jsxs("span",{className:"flex items-center gap-2 text-violet-400 font-medium",children:[e.jsx(u,{size:16}),i.title]}),e.jsx("button",{onClick:()=>d(i.code,t),className:"flex items-center gap-1 px-3 py-1 bg-white/10 hover:bg-white/20 rounded text-sm transition-colors",children:s===t?e.jsxs(e.Fragment,{children:[e.jsx(b,{size:14,className:"text-green-400"}),"Copied"]}):e.jsxs(e.Fragment,{children:[e.jsx(f,{size:14}),"Copy"]})})]}),e.jsx("pre",{className:"p-4 overflow-x-auto text-sm",children:e.jsx("code",{className:"text-gray-700 dark:text-gray-300 mono",children:i.code})})]},t))}),e.jsxs("div",{className:"bg-gradient-to-r from-violet-900/20 to-cyan-900/20 rounded-xl p-6 border border-violet-500/30",children:[e.jsx("h4",{className:"text-lg font-bold text-violet-400 mb-4",children:"📦 Quick Install Commands"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium text-sm mb-1",children:"Core Libraries"}),e.jsx("code",{className:"text-xs text-gray-800 dark:text-gray-400",children:"pip install numpy gensim scikit-learn"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium text-sm mb-1",children:"Visualization"}),e.jsx("code",{className:"text-xs text-gray-800 dark:text-gray-400",children:"pip install matplotlib seaborn"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium text-sm mb-1",children:"Training GloVe"}),e.jsx("code",{className:"text-xs text-gray-800 dark:text-gray-400",children:"pip install mittens"})]}),e.jsxs("div",{className:"bg-black/30 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium text-sm mb-1",children:"PyTorch Integration"}),e.jsx("code",{className:"text-xs text-gray-800 dark:text-gray-400",children:"pip install torch torchtext"})]})]})]}),e.jsxs("div",{className:"bg-black/30 rounded-xl p-6 border border-white/10",children:[e.jsx("h4",{className:"text-lg font-bold text-violet-400 mb-4",children:"🔗 Download Pre-trained GloVe"}),e.jsxs("p",{className:"text-gray-700 dark:text-gray-300 mb-4 text-sm",children:["Download from Stanford NLP: ",e.jsx("a",{href:"https://nlp.stanford.edu/projects/glove/",target:"_blank",rel:"noopener noreferrer",className:"text-violet-400 hover:underline",children:"nlp.stanford.edu/projects/glove/"})]}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-3 text-sm",children:[e.jsxs("div",{className:"bg-white/5 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium",children:"glove.6B.zip (822 MB)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"Wikipedia 2014 + Gigaword 5"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"50d, 100d, 200d, 300d"})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium",children:"glove.42B.300d.zip (1.9 GB)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"Common Crawl (42B tokens)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"300d vectors only"})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium",children:"glove.840B.300d.zip (2.0 GB)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"Common Crawl (840B tokens)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"300d vectors only"})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-3",children:[e.jsx("p",{className:"text-cyan-600 dark:text-cyan-400 font-medium",children:"glove.twitter.27B.zip (1.4 GB)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"Twitter (27B tokens)"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-500",children:"25d, 50d, 100d, 200d"})]})]})]})]})}export{N as default};
