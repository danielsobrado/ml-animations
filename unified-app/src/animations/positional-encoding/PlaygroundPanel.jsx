    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-cyan-600 mb-4">Encoding Playground</h2>
            ...
            <div className="w-full max-w-4xl mb-8">
                <label className="block text-sm font-bold text-slate-700 mb-2">Your Sentence:</label>
                <input
                    type="text"
                    value={sentence}
                ...
                <div className="mt-6 pt-6 border-t border-slate-700">
                    <div className="flex items-center justify-center gap-4 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-800">-1.0</span>
                        </div>
                        <div className="flex items-center gap-2">
            ...
            <div className="grid md:grid-cols-3 gap-4 w-full max-w-5xl mt-8">
                ...
                <div className="bg-slate-700/50 border-2 border-slate-500 p-4 rounded-lg">
                    <h4 className="font-bold text-slate-700 mb-2">❌ Integer</h4>
                    <p className="text-sm text-slate-700">
                        • Too simple
