    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-800">Stacking it all together</p>
            </div>

            {/* Interactive Configurator */}
            <div className="bg-gray-800 rounded-lg p-6 space-y-6">
                <h3 className="text-xl font-semibold text-emerald-600">GPT-2 Configurations</h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-gray-900 p-4 rounded text-center">
                        <div className="text-gray-800">Layers</div>
                        <div className="text-2xl font-mono text-emerald-600">{currentConfig.layers}</div>
                    </div>
                    <div className="bg-gray-900 p-4 rounded text-center">
                        <div className="text-gray-800">Heads</div>
                        <div className="text-2xl font-mono text-emerald-600">{currentConfig.heads}</div>
                    </div>
                    <div className="bg-gray-900 p-4 rounded text-center">
                        <div className="text-gray-800">Embedding Dim</div>
                        <div className="text-2xl font-mono text-emerald-600">{currentConfig.d_model}</div>
                    </div>
                    <div className="bg-gray-900 p-4 rounded text-center">
                        <div className="text-gray-800">Parameters</div>
                        <div className="text-2xl font-mono text-emerald-600">{currentConfig.params}</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 space-y-4 flex flex-col items-center">
                <h3 className="text-xl font-semibold text-emerald-600">The Stack</h3>
                <div className="w-64 border-2 border-gray-700 rounded-lg p-2 bg-gray-900">
                    ...
                    <div className="space-y-1 mb-2 relative">
                        ...
                        <div className="absolute -left-8 top-0 bottom-0 w-4 border-l-2 border-gray-600 flex items-center">
                            <span className="text-xs text-gray-700 -rotate-90 whitespace-nowrap -ml-8">Repeat {currentConfig.layers}x</span>
                        </div>
                    </div>
