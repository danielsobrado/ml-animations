...
// Tab configuration
const tabs = [
    { id: 'concept', label: '1. Why Flash Attention?', icon: Zap, color: 'from-amber-500 to-orange-500' },
    { id: 'mechanism', label: '2. Tiling Mechanism', icon: Layers, color: 'from-orange-500 to-red-500' },
    { id: 'playground', label: '3. Interactive Demo', icon: Play, color: 'from-red-500 to-rose-500' },
];
