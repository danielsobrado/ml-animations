    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-amber-600 mb-4">Designing Rewards</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 w-full max-w-5xl">
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    ...
                    <div className="flex justify-center gap-2 mb-6">
                        {tools.map(tool => (
                            ...
                            >
                                ...
                                <span className="text-xs text-slate-700 mt-1">{tool.label}</span>
                            </button>
                        ))}
                    </div>
                    ...
                    <p className="text-center text-xs text-slate-700 mt-2">Click grid to place items</p>
                </div>
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    ...
                    <div className="mb-6">
                        <h4 className="text-sm text-slate-800 mb-2">Hypothetical Path (White Dots)</h4>
                    ...
                    <div className="bg-amber-900/20 border border-amber-500/50 p-4 rounded-xl">
                        <h4 className="font-bold text-amber-600 mb-2">Reward Hacking ⚠️</h4>
