    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-emerald-600 mb-4">The Agent-Environment Loop</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 w-full max-w-5xl items-start">
                ...
                <div className="flex flex-col items-center">
                            ...
                            {grid.map((row, r) => (
                                row.map((cell, c) => (
                                    ...
                                    >
                                        ...
                                        {/* Coordinates */}
                                        <span className="absolute top-1 left-1 text-[10px] text-slate-700 font-mono">
                                            {r},{c}
                                        </span>
                    ...
                    <p className="text-xs text-slate-700 mt-2">Use Arrow Keys or Buttons</p>
                </div>
                ...
                <div className="w-full">
                    <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 h-[400px] flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto space-y-3 font-mono text-sm">
                            {log.length === 0 && <div className="text-slate-700 italic">Waiting for action...</div>}
                            {log.map((entry, i) => (
                    ...
                    <div className="mt-6 bg-emerald-900/20 border border-emerald-500/50 p-4 rounded-xl">
                        <h4 className="font-bold text-emerald-600 mb-2">Key Concepts</h4>
