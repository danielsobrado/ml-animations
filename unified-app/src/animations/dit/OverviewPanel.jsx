    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          What is <span className="text-pink-600 dark:text-pink-400">DiT</span>?
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-800 dark:text-gray-400">Noisy Latent</p>
            <p className="text-xs text-gray-700 dark:text-gray-500">z_t</p>
          </div>
          ...
          {blocks.map((block, i) => (
            <React.Fragment key={block.id}>
              ...
              >
                ...
                <p className="text-xs text-gray-800 dark:text-center mt-2">{block.label}</p>
                ...
                {hoveredBlock === block.id && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 p-3 bg-black/90 rounded-lg border border-white/20 w-48 z-10">
                    <p className="text-xs text-gray-700 dark:text-gray-300">{block.desc}</p>
                  </div>
                )}
              </div>
              {i < blocks.length - 1 && <ArrowRight className="text-gray-700 dark:text-gray-500" />}
            </React.Fragment>
          ))}
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-800 dark:text-gray-400">Predicted</p>
            <p className="text-xs text-gray-700 dark:text-gray-500">v or ε</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col md:flex-row items-start gap-4">
          <div className="flex-1 p-4 bg-gray-800/50 rounded-xl border border-gray-600">
            <p className="font-bold text-gray-800 dark:text-gray-400 mb-2">2022</p>
            <p className="text-pink-600 dark:text-pink-400 font-bold">DiT Paper</p>
          ...
          <div className="flex-1 p-4 bg-purple-800/30 rounded-xl border border-purple-500/30">
            <p className="font-bold text-gray-800 dark:text-gray-400 mb-2">2024</p>
            <p className="text-purple-600 dark:text-purple-400 font-bold">SD3 MM-DiT</p>
            <p className="text-xs text-gray-800 dark:text-gray-400 mt-1">
          ...
          <div className="flex-1 p-4 bg-orange-800/30 rounded-xl border border-orange-500/30">
            <p className="font-bold text-gray-800 dark:text-gray-400 mb-2">2024</p>
            <p className="text-orange-600 dark:text-orange-400 font-bold">Flux</p>
            <p className="text-xs text-gray-800 dark:text-gray-400 mt-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          ...
          <p className="text-xs text-gray-800 dark:text-gray-400">Layers (SD3-Large)</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">24</p>
          <p className="text-xs text-gray-800 dark:text-gray-400">Attention Heads</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-2xl font-bold text-violet-400">1536</p>
          <p className="text-xs text-gray-800 dark:text-gray-400">Hidden Dim</p>
        </div>
        <div className="bg-black/30 rounded-xl p-4 text-center border border-white/10">
          <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">2×2</p>
          <p className="text-xs text-gray-800 dark:text-gray-400">Patch Size</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-pink-900/30 to-orange-900/30 rounded-xl p-6 border border-pink-500/30">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
          <div>
            <p className="font-bold text-pink-600 dark:text-pink-400 mb-1">Scalability</p>
            <p>Transformers scale predictably. More parameters = better quality. U-Nets hit diminishing returns.</p>
          </div>
          <div>
            <p className="font-bold text-orange-600 dark:text-orange-400 mb-1">Simplicity</p>
          ...
          <div>
            <p className="font-bold text-cyan-600 dark:text-cyan-400 mb-1">Hardware Efficiency</p>
