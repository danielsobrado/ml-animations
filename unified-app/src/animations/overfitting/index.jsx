...
function predict(x, complexity, datasetId, regularizationId) {
...
function epochProfile(datasetId, regularizationId, maxEpochs) {
  const dataset = DATASETS[datasetId];
  const reg = REGULARIZATION[regularizationId].strength;
...
function curvePath(complexity, datasetId, regularizationId) {
...
function errorPath(profile, key) {
  const max = 58;
