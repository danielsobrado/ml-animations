    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Diffusion Process: <span className="text-fuchsia-600">Noise to Image</span>
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex items-center gap-4 px-4">
          ...
          />
          <span className="text-sm text-gray-800 w-16">{step}/{totalSteps}</span>
        </div>

        {/* Total Steps Control */}
        <div className="flex items-center gap-4 px-4 mt-4">
          <span className="text-sm text-gray-800">Total Steps</span>
          <input
            type="range"
            min="10"
            max="50"
            ...
            className="flex-1 h-2 bg-white/20 rounded-lg appearance-none cursor-pointer"
          />
          <span className="text-sm text-gray-800 w-16">{totalSteps}</span>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-fuchsia-900/30 to-purple-900/30 rounded-2xl p-6 border border-fuchsia-500/30">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-fuchsia-600 font-bold mb-2">1. Input</p>
            <p className="text-sm text-gray-800">
              Current noisy latent x_t + timestep t + text embeddings
            </p>
          </div>
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-purple-600 font-bold mb-2">2. Predict</p>
            <p className="text-sm text-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-800 space-y-2">
              <li><span className="text-blue-600">w = 1:</span> No guidance, may ignore prompt</li>
