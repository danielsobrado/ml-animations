    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Inference Pipeline: <span className="text-fuchsia-600">From Prompt to Image</span>
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4">
          ...
          <div className="flex-1 text-center">
            ...
            <h4 className="font-bold text-blue-600 mb-2">1. Text Encoding</h4>
          ...
          <ArrowRight className="text-gray-700 hidden md:block mt-8" />
          ...
          <div className="flex-1 text-center">
            ...
            <h4 className="font-bold text-gray-800 mb-2">2. Sample Noise</h4>
            <p className="text-xs text-gray-800">
              z₀ ~ N(0, I)<br/>
              Random latent init
            </p>
          ...
          <div className="flex-1 text-center">
            ...
            <h4 className="font-bold text-fuchsia-600 mb-2">3. Denoise Loop</h4>
            <p className="text-xs text-gray-800">
              MMDiT + Euler<br/>
              {steps} iterations
            </p>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
          <Settings size={20} className="text-fuchsia-600" />
          Generation Settings
        </h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* Resolution */}
          <div>
            <label className="text-sm text-gray-800 block mb-3">Resolution</label>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/5 rounded-lg p-3 text-center">
            ...
            <p className="text-xs text-gray-800">Image Tokens</p>
          </div>
          <div className="bg-white/5 rounded-lg p-3 text-center">
            <p className="text-lg font-bold text-purple-600">
              {resolutions[resolution].vram}
            </p>
            <p className="text-xs text-gray-800">Est. VRAM</p>
          </div>
          <div className="bg-white/5 rounded-lg p-3 text-center">
            <p className="text-lg font-bold text-blue-600">
              {steps * 2}
            </p>
            <p className="text-xs text-gray-800">NFE (w/ CFG)</p>
          </div>
          <div className="bg-white/5 rounded-lg p-3 text-center">
            <p className="text-lg font-bold text-green-400">
              ~{Math.round(parseFloat(resolutions[resolution].time) * steps / 28)}s
            </p>
            <p className="text-xs text-gray-800">Est. Time (A100)</p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="py-3 px-4 text-left text-gray-800">Model Size</th>
                <th className="py-3 px-4 text-left text-gray-800">Parameters</th>
                <th className="py-3 px-4 text-left text-gray-800">Min VRAM (FP16)</th>
                <th className="py-3 px-4 text-left text-gray-800">Recommended</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              <tr>
                <td className="py-3 px-4 text-fuchsia-600">SD3-Medium</td>
              ...
              <tr>
                <td className="py-3 px-4 text-blue-600">SD3.5-Large</td>
