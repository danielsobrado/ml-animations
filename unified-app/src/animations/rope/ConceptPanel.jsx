        ...
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-4xl w-full">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div className="bg-violet-50 rounded-xl p-6 border border-violet-200">
                            <h4 className="font-bold text-violet-600 mb-3">Why Rotation?</h4>
                        ...
                        <div className="bg-slate-100 rounded-xl p-6">
                            <h4 className="font-bold text-slate-700 mb-3">The Magic of Relative Position</h4>
                            <p className="text-sm text-slate-600 mb-4">
                                When query at position <strong>m</strong> attends to key at position <strong>n</strong>:
                            </p>
                            <div className="bg-white p-4 rounded-lg font-mono text-sm text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-slate-100 rounded-xl p-6">
                        <h4 className="font-bold text-slate-600 mb-2">Sinusoidal (Original)</h4>
                        <p className="text-sm text-slate-500">
                            Adds position vectors: <code className="bg-slate-200 px-1 rounded">x + PE(pos)</code>
                        </p>
