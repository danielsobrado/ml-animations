...
import { RotateCcw, Calculator, Play } from 'lucide-react';
...
// Tab configuration
const tabs = [
    { id: 'concept', label: '1. Rotation Intuition', icon: RotateCcw, color: 'from-violet-500 to-purple-500' },
    { id: 'mechanism', label: '2. The Math', icon: Calculator, color: 'from-purple-500 to-fuchsia-500' },
    { id: 'playground', label: '3. Interactive Demo', icon: Play, color: 'from-fuchsia-500 to-pink-500' },
];
