    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-emerald-600 mb-4">Medical Testing</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 w-full max-w-5xl mb-8">
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    <label className="flex justify-between text-sm font-bold mb-3">
                        Prevalence: <span className="text-purple-600">{(prevalence * 100).toFixed(1)}%</span>
                    </label>
                    <input
                    ...
                    />
                    <p className="text-xs text-slate-800 mt-2">% of population with disease</p>
                </div>
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    ...
                    />
                    <p className="text-xs text-slate-800 mt-2">P(Pos | Disease) - True Positive Rate</p>
                </div>

                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    <label className="flex justify-between text-sm font-bold mb-3">
                        Specificity: <span className="text-blue-600">{(specificity * 100).toFixed(0)}%</span>
                    </label>
                    <input
                        type="range" min="0.5" max="1" step="0.01"
                        value={specificity}
                    ...
                    />
                    <p className="text-xs text-slate-800 mt-2">P(Neg | Healthy) - True Negative Rate</p>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-900/50 to-emerald-900/50 p-8 rounded-xl border-2 border-cyan-500 w-full max-w-5xl mb-8">
                ...
                <div className="text-center">
                    <div className="text-7xl font-mono font-bold text-cyan-600 mb-2">
                        {(probDiseaseGivenPos * 100).toFixed(1)}%
                    </div>
                    <p className="text-slate-700">P(Disease | Positive Test)</p>
                </div>
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 w-full max-w-5xl">
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                    <div className="bg-red-900/30 p-4 rounded-lg border border-red-700">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center p-2 bg-slate-900 rounded">
                                <span className="text-sm text-slate-700">True Positives:</span>
                                <span className="text-green-400 font-bold">{truePositives}</span>
                            </div>
                            <div className="flex justify-between items-center p-2 bg-slate-900 rounded">
                                <span className="text-sm text-slate-700">False Negatives:</span>
                    ...
                    <div className="bg-green-900/30 p-4 rounded-lg border border-green-700">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center p-2 bg-slate-900 rounded">
                                <span className="text-sm text-slate-700">False Positives:</span>
                                <span className="text-yellow-400 font-bold">{falsePositives}</span>
                            </div>
                            <div className="flex justify-between items-center p-2 bg-slate-900 rounded">
                                <span className="text-sm text-slate-700">True Negatives:</span>
                                <span className="text-blue-600 font-bold">{trueNegatives}</span>
                            </div>
                        </div>
                    </div>
                </div>
