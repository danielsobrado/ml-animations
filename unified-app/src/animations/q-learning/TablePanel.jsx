    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-cyan-600 mb-4">The Q-Table</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 w-full max-w-5xl items-start">
                        ...
                        {qTable.map((row, r) => (
                            row.map((cell, c) => (
                                ...
                                >
                                    ...
                                    {/* Center Label */}
                                    <span className="z-10 font-mono text-xs text-slate-800 pointer-events-none">
                                        {r},{c}
                                    </span>
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 w-full">
                    ...
                    {hoveredCell ? (
                        <div className="space-y-4">
                            {['up', 'down', 'left', 'right'].map(action => (
                                <div key={action} className="flex items-center gap-4">
                                    <span className="w-16 font-bold text-slate-700 uppercase">{action}</span>
                                    <input
                                        type="number"
                        ...
                        <div className="text-slate-700 italic text-center py-12">
