    ...
    return (
        <div className="p-8 h-full flex flex-col items-center">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-cyan-600 mb-4">Word Algebra</h2>
            ...
            <div className="flex gap-4 mb-8">
                <button
                    onClick={() => setStep(0)}
                    className={`px-6 py-2 rounded-lg font-bold transition-all ${step === 0 ? 'bg-cyan-600 text-white' : 'bg-slate-700 text-slate-800'}`}
                >
                    1. Start: King
                </button>
                <button
                    onClick={() => setStep(1)}
                    className={`px-6 py-2 rounded-lg font-bold transition-all ${step === 1 ? 'bg-cyan-600 text-white' : 'bg-slate-700 text-slate-800'}`}
                >
                    2. Subtract: Man
                </button>
                <button
                    onClick={() => setStep(2)}
                    className={`px-6 py-2 rounded-lg font-bold transition-all ${step === 2 ? 'bg-cyan-600 text-white' : 'bg-slate-700 text-slate-800'}`}
                >
                    3. Add: Woman
                </button>
            </div>
