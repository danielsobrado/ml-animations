...
// Tab configuration
const tabs = [
    { id: 'concept', label: '1. What is Multimodal?', icon: BookOpen, color: 'from-indigo-500 to-violet-500' },
    { id: 'architecture', label: '2. Architecture', icon: Layers, color: 'from-blue-500 to-cyan-500' },
    { id: 'flow', label: '3. Data Flow', icon: PlayCircle, color: 'from-green-500 to-emerald-500' },
...
export default function MultimodalLlmAnimation() {
    ...
    const renderPanel = () => {
        switch (activeTab) {
            ...
            case 'architecture':
                return <Suspense fallback={<LoadingPanel />}><ArchitecturePanel /></Suspense>;
            case 'flow':
