                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="flex gap-8 items-center">
                                <div className="bg-green-100 rounded-lg px-3 py-2 border border-green-300">
                                    <div className="text-xs text-center">Visual Tokens</div>
                                ...
                                <div className="bg-blue-100 rounded-lg px-3 py-2 border border-blue-300">
                                    <div className="text-xs text-center">Text Tokens</div>
                                    <div className="flex gap-1 mt-1">
                            ...
                            <div 
                                ...
                                onMouseLeave={() => setHoveredComponent(null)}
                            >
                                <div className="text-sm font-bold text-center mb-2">Combined Token Sequence</div>
                            ...
                            >
                                ...
                                <div className="text-lg font-bold text-center">Language Model</div>
                                <div className="text-sm text-center">Self-Attention + Cross-Attention</div>
                            </div>
