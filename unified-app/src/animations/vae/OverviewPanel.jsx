    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          VAE Architecture: <span className="text-purple-400">The Big Picture</span>
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-8 border border-white/10">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <p className="text-center text-xs text-gray-500">[batch, 784]</p>
          </div>
          ...
          >
            ...
            <p className="text-center text-xs text-gray-500">[batch, latent_dim]</p>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-left py-2 px-4 text-blue-400">Regular Autoencoder</th>
                <th className="text-left py-2 px-4 text-purple-400">Variational AE</th>
              </tr>
            </thead>
            <tbody>
