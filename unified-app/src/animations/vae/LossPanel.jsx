    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          VAE Loss: <span className="text-pink-400">The ELBO</span>
        </h2>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-purple-400 font-mono">{beta.toFixed(1)}</span>
          </div>
          <input
            type="range"
            min="0"
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span className="text-blue-400">Reconstruction Loss</span>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span className="text-purple-400">KL Loss × β</span>
          ...
          <div className="pt-2 border-t border-white/10">
            <div className="flex justify-between text-sm mb-1">
              <span className="text-pink-400 font-bold">Total Loss (ELBO)</span>
      ...
      <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-2xl p-6 border border-purple-500/30">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-black/20 rounded-lg p-3 ring-2 ring-purple-500/50">
            <p className="font-bold text-center text-purple-400">β = 1</p>
            <p className="text-xs text-gray-400 text-center mt-1">
