    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          <span className="text-pink-600">Practice</span> Quiz
        </h2>
      ...
      <div className="bg-black/30 rounded-xl p-4 border border-white/10">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm text-pink-600">{answered.length} / {questions.length}</span>
        </div>
      ...
      <div className="bg-gradient-to-r from-pink-900/20 to-purple-900/20 rounded-xl p-6 border border-pink-500/30">
        <h4 className="flex items-center gap-2 font-bold text-pink-600 mb-4">
          <HelpCircle size={18} />
          Quick Reference
        </h4>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="bg-black/30 rounded-lg p-3">
            ...
            <p className="text-gray-800">Center word → Context words</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-yellow-400 font-medium mb-1">CBOW</p>
            <p className="text-gray-800">Context words → Center word</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-orange-600 font-medium mb-1">Negative Sampling</p>
            <p className="text-gray-800">Binary classification instead of softmax</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-purple-600 font-medium mb-1">Embedding Dimension</p>
            <p className="text-gray-800">Typically 100-300</p>
          </div>
        </div>
      </div>
    </div>
