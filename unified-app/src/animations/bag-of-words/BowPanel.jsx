  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-black/30 rounded-xl p-4 border border-white/10">
        <label className="text-sm text-gray-800 mb-2 block">Enter your text:</label>
        <textarea
          value={inputText}
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            <h4 className="text-sm text-gray-800">Lowercased Tokens:</h4>
            <div className="flex flex-wrap gap-2">
        ...
        {currentStep === 3 && (
          <div className="space-y-4">
            <h4 className="text-sm text-gray-800">Cleaned (no punctuation):</h4>
            <div className="flex flex-wrap gap-2">
        ...
        {currentStep === 4 && (
          <div className="space-y-4">
            <h4 className="text-sm text-gray-800">Vocabulary ({processed.vocab.length} unique words):</h4>
            <div className="flex flex-wrap gap-2">
              {processed.vocab.map((word, i) => (
                ...
                >
                  <span className="text-xs text-gray-800">{i}:</span>
        ...
        {currentStep === 5 && (
          <div className="space-y-4">
            <h4 className="text-sm text-gray-800">Word Frequencies:</h4>
        ...
        {currentStep === 6 && (
          <div className="space-y-4">
            <h4 className="text-sm text-gray-800">Final BoW Vector:</h4>
                    ...
                    {processed.vector.map((count, i) => (
                      ...
                      >
                        <span className={`inline-block w-8 h-8 rounded-full flex items-center justify-center ${
                          count > 0 ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-800'
                        }`}>
                          {count}
                        </span>
                      </td>
            ...
            <div className="bg-gray-800 rounded-lg p-3 mt-4">
              <p className="text-xs text-gray-800 mb-1">Vector representation:</p>
