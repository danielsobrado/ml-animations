    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          <span className="text-cyan-600">Practice</span> Quiz
        </h2>
      ...
      <div className="bg-black/30 rounded-xl p-4 border border-white/10">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm text-cyan-600">{answered.length} / {questions.length}</span>
        </div>
      ...
      <div className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-xl p-6 border border-cyan-500/30">
        <h4 className="flex items-center gap-2 font-bold text-cyan-600 mb-4">
          <HelpCircle size={18} />
          Quick Reference
        </h4>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="bg-black/30 rounded-lg p-3">
            ...
            <p className="text-gray-800">count(word, doc) / |doc|</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-yellow-400 font-medium mb-1">Inverse Document Frequency (IDF)</p>
            <p className="text-gray-800">log(N / DF(word))</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-purple-600 font-medium mb-1">TF-IDF</p>
            <p className="text-gray-800">TF × IDF</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-blue-600 font-medium mb-1">Key Insight</p>
            <p className="text-gray-800">High TF-IDF = common in doc, rare in corpus</p>
          </div>
        </div>
      </div>
    </div>
