      ...
      {activeComparison === 'matrix' && (
        <div className="space-y-6">
          ...
          <div className="bg-black/30 rounded-xl p-4 border border-white/10">
            <h4 className="text-sm text-gray-800 mb-3">Sample Documents:</h4>
            {documents.map((doc, i) => (
              <p key={i} className="text-gray-700 font-mono text-sm">
                Doc {i + 1}: "{doc}"
              </p>
            ))}
          </div>
            ...
            <div className="bg-green-900/20 rounded-xl p-4 border border-green-500/30">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  <thead>
                    <tr>
                      <th className="px-1 py-1 text-left text-gray-800">Doc</th>
                  ...
                  <tbody>
                    {data.bow.map((row, i) => (
                      <tr key={i}>
                        <td className="px-1 py-1 text-gray-800">{i + 1}</td>
                        {row.map((val, j) => (
          ...
          <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
            <h4 className="font-bold text-blue-600 mb-2">💡 Key Insight</h4>
      ...
      {activeComparison === 'table' && (
        <div className="bg-black/30 rounded-xl p-6 border border-white/10">
          <table className="w-full">
            <thead>
              <tr>
                <th className="text-left p-3 text-gray-800">Aspect</th>
            ...
            <tbody>
              {comparisons.map((row, i) => (
                <tr key={i} className="border-t border-white/10">
                  <td className="p-3 text-gray-700 font-medium">{row.aspect}</td>
                  <td className="p-3 text-sm text-gray-800">{row.bow}</td>
                  <td className="p-3 text-sm text-gray-800">{row.tfidf}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {activeComparison === 'usecases' && (
        <div className="space-y-6">
          ...
          <div className="bg-blue-900/20 rounded-xl p-6 border border-blue-500/30">
            <h4 className="font-bold text-blue-600 mb-4 text-center">Quick Decision Guide</h4>
          ...
          <div className="bg-purple-900/20 rounded-xl p-6 border border-purple-500/30">
            <h4 className="font-bold text-purple-600 mb-3">🤔 Neither is Perfect</h4>
