    ...
    return (
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-emerald-600 mb-4">The Markov Property</h2>
                <p className="text-lg text-slate-700 leading-relaxed mb-4">
                    "The future depends <strong>only</strong> on the present, not the past."
                    <br />
                    <span className="text-sm text-slate-800">Memorylessness: P(X<sub>t+1</sub> | X<sub>t</sub>, X<sub>t-1</sub>...) = P(X<sub>t+1</sub> | X<sub>t</sub>)</span>
                </p>
            </div>
            ...
            <div className="relative w-full max-w-4xl h-64 bg-slate-800 rounded-xl border border-slate-700 mb-8 overflow-hidden">
                ...
                {pads.map((pad) => (
                    ...
                    >
                        ...
                        {pad.id === currentPad && (
                            <div className="absolute -bottom-16 w-48 text-center text-xs text-slate-700 bg-slate-900/80 p-2 rounded">
                                Next Jump Probs:
                                <br />
            ...
            <div className="w-full max-w-4xl bg-slate-800 p-4 rounded-xl border border-slate-700">
                <h3 className="text-sm font-bold text-slate-800 mb-2 uppercase tracking-wider">Jump History (Last 10)</h3>
