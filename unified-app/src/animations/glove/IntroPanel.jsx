    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="bg-gradient-to-r from-violet-900/30 to-cyan-900/30 rounded-2xl p-6 border border-violet-500/30">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-800">— Pennington, Socher, Manning (2014)</p>
        </div>
        ...
        <div className="bg-black/30 rounded-xl p-6 border border-white/10">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-2 text-gray-700">
                <CheckCircle size={16} className="text-cyan-600 mt-1 flex-shrink-0" />
                {item}
              </li>
            ))}
          </ul>
      ...
      <div className="bg-black/30 rounded-xl p-6 border border-white/10">
        ...
        <div className="bg-gradient-to-r from-violet-900/20 to-cyan-900/20 rounded-lg p-4 mb-4">
          <p className="text-gray-700">
            Consider words <span className="text-violet-400 font-mono">"ice"</span> and <span className="text-cyan-600 font-mono">"steam"</span>.
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="text-left py-2 px-3 text-gray-800">Probability Ratio</th>
                <th className="py-2 px-3 text-cyan-600 font-mono">k = solid</th>
            ...
            <tbody>
              <tr className="border-b border-white/10">
                <td className="py-2 px-3 text-gray-700 font-mono">P(k | ice)</td>
                <td className="py-2 px-3 text-gray-800">1.9 × 10⁻⁴</td>
                <td className="py-2 px-3 text-gray-800">6.6 × 10⁻⁵</td>
                <td className="py-2 px-3 text-gray-800">3.0 × 10⁻³</td>
                <td className="py-2 px-3 text-gray-800">1.7 × 10⁻⁵</td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-2 px-3 text-gray-700 font-mono">P(k | steam)</td>
                <td className="py-2 px-3 text-gray-800">2.2 × 10⁻⁵</td>
                <td className="py-2 px-3 text-gray-800">7.8 × 10⁻⁴</td>
                <td className="py-2 px-3 text-gray-800">2.2 × 10⁻³</td>
                <td className="py-2 px-3 text-gray-800">1.8 × 10⁻⁵</td>
              </tr>
              <tr className="bg-violet-900/20">
                <td className="py-2 px-3 text-white font-bold">P(k|ice) / P(k|steam)</td>
                <td className="py-2 px-3 text-cyan-600 font-bold text-center">8.9</td>
          ...
          {[
            ...
            <React.Fragment key={i}>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xs text-gray-800 max-w-[120px]">{item.desc}</p>
              </div>
              {i < arr.length - 1 && (
                <ArrowRight className="text-gray-800 hidden md:block" size={24} />
              )}
            </React.Fragment>
          ))}
        </div>
      ...
      <div className="bg-gradient-to-r from-violet-900/20 to-cyan-900/20 rounded-xl p-6 border border-violet-500/30">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-cyan-600 font-medium mb-1">Wikipedia + Gigaword</p>
            <p className="text-sm text-gray-800">6B tokens, 400K vocab</p>
            <p className="text-xs text-gray-700">50d, 100d, 200d, 300d vectors</p>
          </div>
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-cyan-600 font-medium mb-1">Common Crawl (42B)</p>
            <p className="text-sm text-gray-800">42B tokens, 1.9M vocab</p>
            <p className="text-xs text-gray-700">300d vectors</p>
          </div>
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-cyan-600 font-medium mb-1">Common Crawl (840B)</p>
            <p className="text-sm text-gray-800">840B tokens, 2.2M vocab</p>
            <p className="text-xs text-gray-700">300d vectors</p>
          </div>
          <div className="bg-black/30 rounded-lg p-4">
            <p className="text-cyan-600 font-medium mb-1">Twitter (27B)</p>
            <p className="text-sm text-gray-800">27B tokens, 1.2M vocab</p>
            <p className="text-xs text-gray-700">25d, 50d, 100d, 200d vectors</p>
          </div>
        </div>
      </div>
