    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            {corpus.map((sentence, i) => (
              <div key={i} className="bg-black/30 rounded-lg p-3">
                <span className="text-gray-700">Sentence {i + 1}:</span>
        ...
        <div className={`bg-black/30 rounded-xl p-6 border border-white/10 transition-opacity ${step >= 4 ? 'opacity-100' : 'opacity-30'}`}>
          <h4 className="text-lg font-bold text-cyan-600 mb-4">
          ...
          <div className="overflow-x-auto">
            <table className="text-xs">
              ...
              <tbody>
                {words.map(w1 => (
                  <tr key={w1}>
                    <td className="p-1 text-cyan-600 font-mono">{w1}</td>
                    {words.map(w2 => (
                      <td
                        key={w2}
          ...
          <div className="mt-4 flex items-center gap-2 text-xs">
            <span className="text-gray-800">Intensity:</span>
            ...
            <span className="text-gray-800">0 → High</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-black/30 rounded-xl p-6 border border-white/10">
              ...
              <span
                ...
                className={`px-4 py-2 rounded-lg font-mono text-lg ${
                  i === 2
                    ...
                    ? 'bg-cyan-900/50 text-cyan-600 border border-cyan-500/50'
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-800">
              ...
              Context words: <span className="text-cyan-600 font-mono">{windowSize === 1 ? '"like", "learning"' : windowSize === 2 ? '"I", "like", "learning"' : '"I", "like", "learning"'}</span>
            </p>
          </div>
        </div>
      )}
        ...
        <div className="bg-gradient-to-r from-violet-900/20 to-cyan-900/20 rounded-xl p-6 border border-violet-500/30">
          ...
          <div className="bg-black/30 rounded-lg p-4 font-mono text-center">
            <p className="text-xl text-gray-200">
              P(j | i) = X<sub className="text-violet-400">ij</sub> / X<sub className="text-cyan-600">i</sub>
            </p>
            <p className="text-sm text-gray-800 mt-2">
              where X<sub className="text-cyan-600">i</sub> = Σ<sub>k</sub> X<sub>ik</sub> (row sum)
            </p>
          </div>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-black/30 rounded-lg p-3">
              <p className="text-sm text-cyan-600 font-medium">Why Probabilities?</p>
              <p className="text-xs text-gray-800 mt-1">
      ...
      <div className="bg-black/30 rounded-xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-cyan-900/20 rounded-lg p-3">
            <p className="text-cyan-600 font-medium mb-1">Window Size Matters</p>
            <p className="text-sm text-gray-800">
