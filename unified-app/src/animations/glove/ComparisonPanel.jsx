    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-violet-900/30 to-violet-800/20 rounded-xl p-6 border border-violet-500/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">Global Vectors</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-cyan-900/30 to-cyan-800/20 rounded-xl p-6 border border-cyan-500/30">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-3xl">🎯</span>
            <div>
              <h3 className="text-xl font-bold text-cyan-600">Word2Vec</h3>
              <p className="text-sm text-gray-800">Skip-gram / CBOW</p>
            </div>
          </div>
          <p className="text-gray-700">
            <strong className="text-cyan-600">Prediction-based method</strong> that learns word
      ...
      <div className="bg-black/30 rounded-xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-cyan-900/20 rounded-lg p-4 border border-cyan-500/30">
            <h5 className="text-cyan-600 font-bold mb-4 flex items-center gap-2">
              🎯 Word2Vec
            </h5>
            <ul className="space-y-3">
              {aspects[selectedAspect].word2vec.items.map((item, i) => (
                <li key={i} className="flex items-start gap-2 text-gray-700">
                  <CheckCircle size={16} className="text-cyan-600 mt-0.5 flex-shrink-0" />
                  {item}
                </li>
              ))}
            </ul>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/20">
              <th className="text-left py-2 px-3 text-gray-800">Aspect</th>
              <th className="py-2 px-3 text-violet-400">GloVe</th>
              <th className="py-2 px-3 text-cyan-600">Word2Vec</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-white/10">
            <tr>
              <td className="py-3 px-3 text-gray-700">Approach</td>
              <td className="py-3 px-3 text-center text-gray-800">Count-based</td>
              <td className="py-3 px-3 text-center text-gray-800">Prediction-based</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Statistics</td>
              <td className="py-3 px-3 text-center text-gray-800">Global</td>
              <td className="py-3 px-3 text-center text-gray-800">Local</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Optimization</td>
              <td className="py-3 px-3 text-center text-gray-800">Weighted Least Squares</td>
              <td className="py-3 px-3 text-center text-gray-800">SGD + Negative Sampling</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Pre-processing</td>
              <td className="py-3 px-3 text-center text-gray-800">Build co-occurrence matrix</td>
              <td className="py-3 px-3 text-center text-gray-800">None (online)</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Memory Usage</td>
              <td className="py-3 px-3 text-center text-gray-800">Higher (stores matrix)</td>
              <td className="py-3 px-3 text-center text-gray-800">Lower</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Training Speed</td>
              <td className="py-3 px-3 text-center text-gray-800">Faster on large corpora</td>
              <td className="py-3 px-3 text-center text-gray-800">Good for medium corpora</td>
            </tr>
            <tr>
              <td className="py-3 px-3 text-gray-700">Incremental Learning</td>
      ...
      <div className="bg-black/30 rounded-xl p-6 border border-white/10 text-center">
        ...
        <p className="text-gray-700 max-w-2xl mx-auto">
          ...
          <strong className="text-cyan-600"> specific task requirements</strong>.
