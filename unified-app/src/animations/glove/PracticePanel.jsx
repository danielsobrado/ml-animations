      ...
      <div className="bg-gradient-to-r from-violet-900/20 to-cyan-900/20 rounded-xl p-6 border border-violet-500/30">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="bg-black/30 rounded-lg p-3">
            ...
            <p className="text-gray-800 font-mono text-xs">J = Σ f(X)(w·w̃ + b - log X)²</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-cyan-600 font-medium mb-1">Weighting Function</p>
            <p className="text-gray-800 font-mono text-xs">f(x) = (x/x_max)^0.75 if x &lt; 100</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-green-400 font-medium mb-1">Final Embedding</p>
            <p className="text-gray-800">W + W̃ (word + context)</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-yellow-400 font-medium mb-1">Key Insight</p>
            <p className="text-gray-800">P(k|i) / P(k|j) encodes meaning</p>
          </div>
        </div>
      </div>
    </div>
