    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">
          Logit-Normal Sampling: <span className="text-fuchsia-600">Time Distribution</span>
        </h2>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              <strong className="text-fuchsia-600"> Uniform sampling</strong> treats all timesteps equally,
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="bg-black/30 rounded-lg p-4 font-mono text-sm space-y-2">
              <p className="text-gray-800"># 1. Sample from standard normal</p>
              <p><span className="text-blue-600">z</span> ~ N(0, 1)</p>
              <p className="text-gray-800 mt-2"># 2. Transform to logit scale</p>
              <p><span className="text-blue-600">logit</span> = μ + σ × z</p>
              <p className="text-gray-800 mt-2"># 3. Apply sigmoid</p>
              <p><span className="text-blue-600">t</span> = sigmoid(logit)</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                <th className="py-3 px-4 text-left text-gray-800">Strategy</th>
                <th className="py-3 px-4 text-left text-gray-800">Distribution</th>
                <th className="py-3 px-4 text-left text-gray-800">Focus</th>
                <th className="py-3 px-4 text-left text-gray-800">Used By</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              <tr>
                <td className="py-3 px-4 text-gray-700">Uniform</td>
                <td className="py-3 px-4">t ~ U(0, 1)</td>
                <td className="py-3 px-4">Equal for all t</td>
                <td className="py-3 px-4">DDPM, DDIM</td>
              </tr>
              <tr>
                <td className="py-3 px-4 text-fuchsia-600">Logit-Normal</td>
                <td className="py-3 px-4">t = σ(μ + σz)</td>
                <td className="py-3 px-4">Middle timesteps</td>
                <td className="py-3 px-4">SD3, Flux</td>
              </tr>
              <tr>
                <td className="py-3 px-4 text-purple-600">Mode Seeking</td>
