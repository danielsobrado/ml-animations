    ...
    return (
        <div className="p-8 h-full flex flex-col items-center">
            ...
            <div className="flex gap-4 mb-8">
                <button
                    onClick={() => setMode('raw')}
                    className={`px-6 py-3 rounded-lg font-bold transition-colors ${mode === 'raw' ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-800'}`}
                >
                    Show Raw Values
                </button>
                <button
                    onClick={() => setMode('rank')}
                    className={`px-6 py-3 rounded-lg font-bold transition-colors ${mode === 'rank' ? 'bg-green-600 text-white' : 'bg-slate-200 text-slate-800'}`}
                >
                    Show Ranks
                </button>
            </div>
