        ...
        <div className="p-8 h-full flex flex-col items-center">
            ...
            <div className="w-full max-w-4xl overflow-hidden rounded-xl shadow-lg border border-slate-200 bg-white">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-slate-100 text-slate-800 uppercase text-sm font-bold">
                        <tr>
                        ...
                        <AnimatePresence>
                            {displayData.map((row) => (
                                ...
                                >
                                    ...
                                    <td className="p-4 text-slate-800">{row.x}</td>
                                    <td className="p-4 text-slate-800">{row.y}</td>
                    ...
                    {step >= 5 && (
                        <tfoot className="bg-slate-50 font-bold">
                            <tr>
                                <td colSpan="6" className="p-4 text-right text-slate-800">Sum (Σd²):</td>
            ...
            {step >= 6 && (
                <div className="mt-8 p-6 bg-white rounded-xl shadow-lg border-2 border-indigo-100 text-center animate-fade-in">
                    <p className="text-slate-700 mb-2">Formula Application</p>
