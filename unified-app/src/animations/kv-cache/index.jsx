...
import { Database, Calculator, Play } from 'lucide-react';
...
// Tab configuration
const tabs = [
    { id: 'concept', label: '1. Why KV Cache?', icon: Database, color: 'from-emerald-500 to-teal-500' },
    { id: 'mechanism', label: '2. How It Works', icon: Calculator, color: 'from-teal-500 to-cyan-500' },
    { id: 'playground', label: '3. Interactive Demo', icon: Play, color: 'from-cyan-500 to-blue-500' },
];
