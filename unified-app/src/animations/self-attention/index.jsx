...
// Tab configuration
const tabs = [
    { id: 'concept', label: '1. The Concept (Q, K, V)', icon: Key, color: 'from-fuchsia-500 to-purple-500' },
    { id: 'mechanism', label: '2. The Mechanism (Math)', icon: Calculator, color: 'from-purple-500 to-indigo-500' },
    { id: 'playground', label: '3. Attention Playground', icon: MessageSquare, color: 'from-indigo-500 to-violet-500' },
];
