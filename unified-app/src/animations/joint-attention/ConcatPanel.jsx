    ...
    <div className="space-y-8">
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div>
            <label className="text-sm text-blue-600 block mb-2">
          ...
          <div>
            <label className="text-sm text-orange-600 block mb-2">
        ...
        <div className="bg-black/30 rounded-xl p-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-600">Image Tokens</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-orange-600">Text Tokens</p>
            </div>
          </div>
          ...
          {/* After - Concatenated */}
          <div className="text-center">
            <p className="text-sm text-gray-800 mb-3">Concatenated Sequence (length: {imageTokens + textTokens})</p>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-900/20 rounded-xl p-5 border border-blue-500/30">
            <h4 className="font-bold text-blue-600 mb-3">Image Tokens</h4>
          ...
          <div className="bg-orange-900/20 rounded-xl p-5 border border-orange-500/30">
            <h4 className="font-bold text-orange-600 mb-3">Text Tokens</h4>
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="bg-black/50 rounded-lg p-4 font-mono text-sm overflow-x-auto">
          <pre className="text-gray-700">{`# Pseudo-code for token concatenation
