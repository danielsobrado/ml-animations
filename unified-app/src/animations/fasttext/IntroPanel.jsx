      ...
      >
        <div className="flex items-center gap-4 justify-center flex-wrap">
          <div className="text-center">
            <div className="text-purple-600 font-semibold">2013</div>
            <div className="text-sm text-purple-200/70">Word2Vec</div>
          </div>
          <div className="text-purple-600">→</div>
          <div className="text-center">
            <div className="text-purple-600 font-semibold">2014</div>
          ...
          <div className="text-center px-4 py-2 bg-purple-500/30 rounded-lg border border-purple-400/50">
            <div className="text-pink-600 font-semibold">2016</div>
            <div className="text-sm text-white">FastText</div>
          </div>
          <div className="text-purple-600">→</div>
          <div className="text-center">
            <div className="text-purple-600 font-semibold">2018</div>
