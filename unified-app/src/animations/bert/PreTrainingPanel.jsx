  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`rounded-xl p-4 border ${
        ...
        <p className="text-gray-700 mt-1">{currentSteps[currentStepIndex].description}</p>
      </div>
        ...
        <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className={`transition-all duration-500 ${mlmStep >= 0 ? 'opacity-100' : 'opacity-30'}`}>
              <p className="text-sm text-gray-800 mb-2">Original sentence:</p>
            ...
            <div className={`transition-all duration-500 ${mlmStep >= 1 ? 'opacity-100' : 'opacity-30'}`}>
              <p className="text-sm text-gray-800 mb-2">After masking (15% tokens):</p>
              <div className="flex flex-wrap gap-2">
            ...
            {mlmStep >= 3 && (
              <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-3">
                ...
                <code className="text-xs text-gray-800 mt-1 block">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            ...
            <div className={`p-4 rounded-xl border-2 transition-all duration-500 ${
              ...
              <div className={`transition-all ${nspStep >= 1 ? 'opacity-100' : 'opacity-50'}`}>
                <p className="text-xs text-gray-800">[CLS]</p>
                <p className="text-sm">{nspExample.positive.sentA}</p>
                <p className="text-xs text-gray-800">[SEP]</p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
          <h4 className="font-bold text-blue-600 mb-3">⚙️ Pre-Training Config</h4>
          <ul className="text-sm text-gray-700 space-y-2">
      ...
      <div className="bg-gradient-to-r from-yellow-900/20 to-purple-900/20 rounded-xl p-4 border border-white/20">
        ...
        <div className="bg-black/30 rounded-lg p-4 text-center">
          <code className="text-lg">
            ...
            <span className="text-gray-800">_total</span>
      ...
      <div className="bg-orange-900/20 rounded-xl p-4 border border-orange-500/30">
        <h4 className="font-bold text-orange-600 mb-2">⚠️ Note on NSP</h4>
      ...
      <div className="bg-black/40 rounded-xl p-4 border border-white/10">
        <p className="text-sm text-gray-800 mb-3">🐍 PyTorch Pre-Training Heads:</p>
