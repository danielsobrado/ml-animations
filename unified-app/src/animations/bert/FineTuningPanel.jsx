    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-center gap-4 min-w-max">
          ...
          <div className={`text-center transition-all duration-500 ${currentStep >= 0 ? 'opacity-100 scale-100' : 'opacity-30 scale-90'}`}>
            <div className="bg-blue-900/30 border-2 border-blue-500 rounded-xl p-4 w-48">
              ...
              <p className="text-xs text-gray-800 mt-1">12 Encoder Layers</p>
              <p className="text-xs text-gray-800">110M Parameters</p>
            </div>
          </div>
          ...
          <div className={`text-center transition-all duration-500 ${currentStep >= 1 ? 'opacity-100 scale-100' : 'opacity-30 scale-90'}`}>
            <div className={`bg-${currentTask.color}-900/30 border-2 border-${currentTask.color}-500 rounded-xl p-4 w-48`}>
              ...
              <p className="text-xs text-gray-800 mt-1">{currentTask.head}</p>
              <p className="text-xs text-gray-800">~Few K params</p>
            </div>
          </div>
          ...
          <div className={`text-center transition-all duration-500 ${currentStep >= 2 ? 'opacity-100 scale-100' : 'opacity-30 scale-90'}`}>
            <div className="bg-green-900/30 border-2 border-green-500 rounded-xl p-4 w-48">
              ...
              <p className="text-xs text-gray-800 mt-1">Labeled examples</p>
              <p className="text-xs text-gray-800">~1K - 100K samples</p>
            </div>
          </div>
          ...
          <div className={`text-center transition-all duration-500 ${currentStep >= 3 ? 'opacity-100 scale-100' : 'opacity-30 scale-90'}`}>
            <div className="bg-yellow-900/30 border-2 border-yellow-500 rounded-xl p-4 w-48">
              ...
              <p className="text-xs text-gray-800 mt-1">Task-specific</p>
              <p className="text-xs text-gray-800">2-4 epochs</p>
            </div>
          </div>
          ...
          <div className={`text-center transition-all duration-500 ${currentStep >= 4 ? 'opacity-100 scale-100' : 'opacity-30 scale-90'}`}>
            <div className="bg-purple-900/30 border-2 border-purple-500 rounded-xl p-4 w-48">
              ...
              <p className="text-xs text-gray-800 mt-1">Ready for inference</p>
              <p className="text-xs text-gray-800">State-of-the-art!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className={`bg-${currentTask.color}-900/20 rounded-xl p-4 border border-${currentTask.color}-500/30`}>
          ...
          <p className="text-sm text-gray-700 mb-4">{currentTask.description}</p>

          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-800 mb-1">Input Format:</p>
              <code className="text-xs bg-black/30 px-2 py-1 rounded text-green-300 block">
                {currentTask.inputFormat}
              </code>
            </div>
            <div>
              <p className="text-xs text-gray-800 mb-1">Output:</p>
          ...
          <div className="mt-4">
            <p className="text-xs text-gray-800 mb-2">Example Tasks:</p>
      ...
      <div className="bg-gradient-to-r from-blue-900/20 to-yellow-900/20 rounded-xl p-4 border border-white/20">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-blue-600 font-medium mb-1">BERT Weights (All)</p>
            <p className="text-gray-800">All 110M parameters get updated with small gradients</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-yellow-400 font-medium mb-1">Task Head (New)</p>
            <p className="text-gray-800">New layers trained from scratch</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-green-400 font-medium mb-1">Option: Freeze BERT</p>
            <p className="text-gray-800">Only train head (faster, less accurate)</p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/20">
                ...
                <th className="text-center py-2 text-gray-800">Dataset</th>
            ...
            <tbody>
              <tr className="border-b border-white/10">
                ...
                <td className="text-center text-gray-800">SST-2</td>
              ...
              <tr className="border-b border-white/10">
                ...
                <td className="text-center text-gray-800">MNLI</td>
              ...
              <tr className="border-b border-white/10">
                ...
                <td className="text-center text-gray-800">QQP</td>
              ...
              <tr>
                ...
                <td className="text-center text-gray-800">QNLI</td>
      ...
      <div className="bg-black/40 rounded-xl p-4 border border-white/10">
        <p className="text-sm text-gray-800 mb-3">🐍 PyTorch Fine-Tuning Example (Classification):</p>
