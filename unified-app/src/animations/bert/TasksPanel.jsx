  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-xl p-4 text-center">
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-1">{currentTask.description}</p>
      </div>
      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        {selectedTask === 'sentiment' && (
          <div className="space-y-4">
            <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-2">Input Text:</p>
              <p className="text-lg text-blue-300">"{currentTask.example.input}"</p>
            </div>
            
            <div className="flex justify-center">
              <ArrowRight className="text-gray-700 dark:text-gray-500 rotate-90" size={24} />
            </div>
            ...
            <div className="flex justify-center gap-2 text-sm">
              {currentTask.example.process.map((step, i) => (
                <React.Fragment key={i}>
                  ...
                  {i < currentTask.example.process.length - 1 && <span className="text-gray-700 dark:text-gray-500">→</span>}
                </React.Fragment>
              ))}
            </div>
            ...
            <div className="bg-green-900/20 rounded-xl p-4 border border-green-500/30 text-center">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-2">Output:</p>
              <p className="text-2xl font-bold text-green-400">{currentTask.example.output}</p>
              <div className="mt-3 flex justify-center gap-4">
                <span className="px-3 py-1 bg-green-600/30 rounded text-sm">Positive</span>
                <span className="px-3 py-1 bg-gray-600/30 rounded text-gray-800 dark:text-sm">Neutral</span>
                <span className="px-3 py-1 bg-red-600/30 rounded text-gray-800 dark:text-sm">Negative</span>
              </div>
            </div>
          </div>
        )}
        ...
        {selectedTask === 'ner' && (
          <div className="space-y-4">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-3">Entity Labels (BIO format):</p>
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="bg-blue-900/30 rounded-lg p-2 border border-blue-500/30">
                <p className="text-blue-600 dark:text-blue-400 font-medium">PERSON</p>
                <p className="text-sm text-gray-700 dark:text-gray-300">Elon Musk</p>
              </div>
              <div className="bg-green-900/30 rounded-lg p-2 border border-green-500/30">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300">SpaceX</p>
              </div>
              <div className="bg-purple-900/30 rounded-lg p-2 border border-purple-500/30">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300">Hawthorne, California</p>
              </div>
            </div>
          </div>
        )}
        ...
        {selectedTask === 'qa' && (
          <div className="space-y-4">
            <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/30">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-1">Question:</p>
              <p className="text-lg text-purple-300 font-medium">{currentTask.example.question}</p>
            </div>

            <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-1">Context:</p>
              <p className="text-lg">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4">
              ...
              <div className="flex gap-4 justify-center">
                <div className="text-center">
                  <p className="text-xs text-gray-700 dark:text-gray-500">Start Position</p>
                  <p className="text-2xl font-mono text-yellow-400">7</p>
                  <p className="text-xs text-gray-800 dark:text-gray-400">"October"</p>
                </div>
                <div className="text-center">
                  <p className="text-xs text-gray-700 dark:text-gray-500">End Position</p>
                  <p className="text-2xl font-mono text-yellow-400">8</p>
                  <p className="text-xs text-gray-800 dark:text-gray-400">"2018"</p>
                </div>
              </div>
            </div>

            <div className="bg-green-900/20 rounded-xl p-4 border border-green-500/30 text-center">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-1">Answer:</p>
        ...
        {selectedTask === 'nli' && (
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
                <p className="text-sm text-blue-600 dark:text-blue-400 mb-1">Premise:</p>
                <p className="text-lg text-gray-200">{currentTask.example.premise}</p>
              </div>
              <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/30">
                <p className="text-sm text-purple-600 dark:text-purple-400 mb-1">Hypothesis:</p>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-3">Does the premise entail the hypothesis?</p>
              <div className="flex justify-center gap-4">
                <div className="bg-green-600/30 px-4 py-2 rounded-lg border-2 border-green-500">
                  ...
                  <p className="text-xs text-gray-800 dark:text-gray-400">89.2%</p>
                </div>
                <div className="bg-gray-600/30 px-4 py-2 rounded-lg border border-gray-500">
                  <p className="text-gray-800 dark:text-gray-400">Contradiction</p>
                  <p className="text-xs text-gray-700 dark:text-gray-500">3.1%</p>
                </div>
                <div className="bg-gray-600/30 px-4 py-2 rounded-lg border border-gray-500">
                  <p className="text-gray-800 dark:text-gray-400">Neutral</p>
                  <p className="text-xs text-gray-700 dark:text-gray-500">7.7%</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {selectedTask === 'similarity' && (
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
                <p className="text-sm text-blue-600 dark:text-blue-400 mb-1">Sentence A:</p>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4">
              <p className="text-sm text-gray-800 dark:text-gray-400 mb-3 text-center">Similarity Score:</p>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-500/30">
          <p className="text-sm text-blue-600 dark:text-blue-400 font-medium mb-2">📥 Input Format</p>
          <code className="text-xs bg-black/30 px-2 py-1 rounded text-gray-700 dark:text-gray-300 block">
            {currentTask.inputFormat}
          </code>
        </div>
        <div className="bg-green-900/20 rounded-xl p-4 border border-green-500/30">
          <p className="text-sm text-green-400 font-medium mb-2">📤 Output Type</p>
          <p className="text-xs text-gray-700 dark:text-gray-300">{currentTask.outputType}</p>
        </div>
        <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/30">
          <p className="text-sm text-purple-600 dark:text-purple-400 font-medium mb-2">📊 Performance</p>
          <p className="text-xs text-gray-700 dark:text-gray-300">{currentTask.metrics}</p>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/20">
              ...
              <th className="text-center py-2 text-gray-800 dark:text-gray-400">Output</th>
              <th className="text-center py-2 text-gray-800 dark:text-gray-400">Head</th>
              <th className="text-center py-2 text-gray-800 dark:text-gray-400">From</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-white/10">
              <td className="py-2">Classification</td>
              <td className="text-center text-gray-800 dark:text-gray-400">Single label</td>
              <td className="text-center font-mono text-xs">Linear(H, C)</td>
              <td className="text-center text-blue-600 dark:text-blue-400">[CLS]</td>
            </tr>
            <tr className="border-b border-white/10">
              <td className="py-2">NER</td>
              <td className="text-center text-gray-800 dark:text-gray-400">Label per token</td>
            ...
            <tr className="border-b border-white/10">
              ...
              <td className="text-center text-gray-800 dark:text-gray-400">Start/End pos</td>
              <td className="text-center font-mono text-xs">Linear(H, 2)</td>
              <td className="text-center text-purple-600 dark:text-purple-400">Context tokens</td>
            </tr>
            <tr className="border-b border-white/10">
              <td className="py-2">NLI</td>
              <td className="text-center text-gray-800 dark:text-gray-400">3 classes</td>
              <td className="text-center font-mono text-xs">Linear(H, 3)</td>
              <td className="text-center text-blue-600 dark:text-blue-400">[CLS]</td>
            </tr>
            <tr>
              <td className="py-2">Similarity</td>
              <td className="text-center text-gray-800 dark:text-gray-400">Score 0-1</td>
              <td className="text-center font-mono text-xs">Linear(H, 1)</td>
              <td className="text-center text-blue-600 dark:text-blue-400">[CLS]</td>
            </tr>
          </tbody>
        </table>
        <p className="text-xs text-gray-700 dark:text-gray-500 mt-2">H = hidden size (768), C = num classes, T = num tags</p>
      </div>
    </div>
  );
}
