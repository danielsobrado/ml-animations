      ...
      <div className="bg-black/30 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <div className="bg-blue-900/30 border border-blue-500/30 rounded-xl p-4 text-center">
            <p className="text-blue-600 font-bold mb-2">Input</p>
          ...
          <div className="bg-purple-900/30 border border-purple-500/30 rounded-xl p-4 text-center">
            <p className="text-purple-600 font-bold mb-2">Transformer Encoders</p>
            ...
            <p className="text-xs text-gray-700 mt-2">Self-Attention + FFN</p>
          </div>
          ...
          <div className="bg-green-900/30 border border-green-500/30 rounded-xl p-4 text-center">
            ...
            <p className="text-xs text-gray-700 mt-2">Contextual embeddings</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {timeline.map((item, i) => (
            <div key={i} className="flex items-center gap-2">
              ...
              {i < timeline.length - 1 && <ArrowRight className="text-gray-800 hidden md:block" />}
            </div>
          ))}
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-white/5">
                <td className="py-2 px-4 text-blue-600 font-medium">BERT-Base</td>
              ...
              <tr className="border-b border-white/5">
                <td className="py-2 px-4 text-purple-600 font-medium">BERT-Large</td>
