    ...
    return (
        <div className="p-8 h-full flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col items-center justify-center relative min-h-[400px]">
                <h3 className="absolute top-4 left-4 text-sm font-bold text-slate-800 uppercase tracking-wider">Interactive Schematic</h3>
                ...
                <div className="relative w-[400px] h-[300px] bg-slate-50 rounded-lg border-2 border-slate-200 p-4">
                    ...
                    <p className="absolute bottom-2 right-2 text-xs text-slate-800">Click components to inspect</p>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center">
                {selectedComponent ? (
                    ...
                    <div className="text-center text-slate-800 p-8 border-2 border-dashed border-slate-200 rounded-xl">
