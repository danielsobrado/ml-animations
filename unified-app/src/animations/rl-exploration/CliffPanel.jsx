                        ...
                        Array(COLS).fill().map((_, c) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isStart && <span className="text-xs text-slate-800">START</span>}
                    ...
                    <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                        ...
                        <div className="mb-6">
                            <div className="flex justify-between items-end mb-2">
                                <label className="text-sm text-slate-800">Exploration (ε)</label>
                    ...
                    <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-slate-900 p-4 rounded text-center">
                                ...
                                <div className="text-xs text-slate-800">Falls (Deaths)</div>
                            </div>
                            <div className="bg-slate-900 p-4 rounded text-center">
                                <div className="text-3xl font-bold text-yellow-500">{wins}</div>
                                <div className="text-xs text-slate-800">Wins (Goals)</div>
                            </div>
                        </div>
                        <div className="mt-4 p-3 bg-red-900/20 border border-red-500/30 rounded text-sm text-slate-700">
                            {epsilon > 0.2 ? (
