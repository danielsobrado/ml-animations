        ...
        <div className="p-6 min-h-screen">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-green-500/20 rounded-xl p-4 mb-6 border border-green-500/30">
                    ...
                    <p className="text-slate-700">{steps[currentStep].description}</p>
                </div>
                ...
                <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 mb-8">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="w-full">
                            <div className="text-slate-800 text-center mb-2">INPUT (English)</div>
                        ...
                        <div className="flex items-start gap-8 w-full justify-center">
                            ...
                            <div className="flex flex-col items-center">
                                <ArrowDown className="text-slate-700 mb-2" />
                            ...
                            {/* Decoder Section */}
                            <div className="flex flex-col items-center">
                                <div className="text-slate-800 mb-2">OUTPUT (French) - shifted</div>
                                ...
                                <ArrowDown className="text-slate-700 my-2" />
                                ...
                                <div className={`w-64 p-4 rounded-lg border-2 border-dashed border-purple-500/50 transition-all ${
                                    ...
                                    <div className="text-purple-600 font-bold text-center mb-2">DECODER ×6</div>
                                    <div className="space-y-2">
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-slate-700">
                                    <th className="text-left text-slate-800 py-2 px-3">Stage</th>
                                    <th className="text-left text-slate-800 py-2 px-3">Shape</th>
                                    <th className="text-left text-slate-800 py-2 px-3">Example</th>
                                </tr>
                            </thead>
                            <tbody className="text-slate-700">
                                <tr className={`border-b border-slate-700/50 ${currentStep === 0 ? 'bg-green-500/10' : ''}`}>
                                    <td className="py-2 px-3">Input tokens</td>
                                    <td className="py-2 px-3 font-mono text-blue-600">[batch, seq_len]</td>
                                ...
                                <tr className={`border-b border-slate-700/50 ${currentStep === 1 ? 'bg-green-500/10' : ''}`}>
                                    ...
                                    <td className="py-2 px-3 font-mono text-indigo-600">[batch, seq_len, d_model]</td>
                                ...
                                <tr className={`border-b border-slate-700/50 ${currentStep === 3 ? 'bg-green-500/10' : ''}`}>
                                    ...
                                    <td className="py-2 px-3 font-mono text-purple-600">[batch, heads, seq, d_k]</td>
                                ...
                                <tr className={`border-b border-slate-700/50 ${currentStep === 3 ? 'bg-green-500/10' : ''}`}>
                                    ...
                                    <td className="py-2 px-3 font-mono text-orange-600">[batch, seq, d_ff]</td>
