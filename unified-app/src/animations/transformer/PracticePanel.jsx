                ...
                {mode === 'quiz' ? (
                    <>
                        ...
                        <div className="text-center mb-6">
                            ...
                            <span className="text-slate-800"> / {answered.length}</span>
                        </div>
                                            ...
                                            showResult
                                                ? i === questions[currentQuestion].correct
                                                    ...
                                                    : selectedAnswer === i
                                                        ...
                                                        : 'bg-slate-700/50 text-slate-800'
                                                : selectedAnswer === i
                                                    ? 'bg-blue-500/20 border-2 border-blue-500 text-white'
                                                    : 'bg-slate-700/50 text-slate-700 hover:bg-slate-700'
                                        }`}
                                    >
                    ...
                    <>
                        ...
                        <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 mb-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                                <div>
                                    <label className="text-slate-800">d_model</label>
                                    <input
                                        type="number"
                                        value={dModel}
                                ...
                                <div>
                                    <label className="text-slate-800">Num Heads</label>
                                    <input
                                        type="number"
                                        value={numHeads}
                                ...
                                <div>
                                    <label className="text-slate-800">Num Layers</label>
                                    <input
                                        type="number"
                                        value={numLayers}
                                ...
                                <div>
                                    <label className="text-slate-800">d_ff</label>
                                    <input
                                        type="number"
                                        value={dFF}
                                ...
                                <div>
                                    <label className="text-slate-800">Vocab Size</label>
                                    <input
                                        type="number"
                                        value={vocabSize}
                                ...
                                <div>
                                    <label className="text-slate-800">Max Seq Len</label>
                                    <input
                                        type="number"
                                        value={seqLen}
                            ...
                            <div className="bg-slate-700/50 p-4 rounded-lg mb-6">
                                <h4 className="text-slate-800 mb-2">Derived Values</h4>
                                <div className="flex gap-6">
                                    <div>
                                        <span className="text-slate-800">d_k = d_v = </span>
                                        <span className="text-indigo-600 font-mono">{dK}</span>
                                    </div>
                                    <div>
                                        <span className="text-slate-800">d_model / h = </span>
                                        <span className="text-indigo-600 font-mono">{dModel} / {numHeads}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center p-3 bg-purple-500/10 rounded-lg">
                                    <span className="text-slate-700">Attention Parameters (per layer × N)</span>
                                    <span className="text-purple-600 font-mono">{formatNumber(attentionParams)}</span>
                                </div>
                                <div className="flex justify-between items-center p-3 bg-orange-500/10 rounded-lg">
                                    <span className="text-slate-700">FFN Parameters (per layer × N)</span>
                                    <span className="text-orange-600 font-mono">{formatNumber(ffnParams)}</span>
                                </div>
                                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg">
                                    <span className="text-slate-700">Embedding Parameters</span>
                                    <span className="text-blue-600 font-mono">{formatNumber(embeddingParams)}</span>
                                </div>
                ...
                <div className="mt-8 bg-amber-500/10 rounded-2xl p-6 border border-amber-500/30">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="flex items-start gap-2">
                            ...
                            <span className="text-slate-700">Encoder: bidirectional, understanding</span>
                        </div>
                        <div className="flex items-start gap-2">
                            <span className="text-green-400">✓</span>
                            <span className="text-slate-700">Decoder: causal, generation</span>
                        </div>
                        <div className="flex items-start gap-2">
                            <span className="text-green-400">✓</span>
                            <span className="text-slate-700">Multi-head = multiple perspectives</span>
                        </div>
                        <div className="flex items-start gap-2">
                            <span className="text-green-400">✓</span>
                            <span className="text-slate-700">Residuals enable deep networks</span>
                        </div>
                        <div className="flex items-start gap-2">
                            <span className="text-green-400">✓</span>
                            <span className="text-slate-700">O(n²) attention complexity</span>
                        </div>
                        <div className="flex items-start gap-2">
                            <span className="text-green-400">✓</span>
                            <span className="text-slate-700">Foundation of all modern LLMs!</span>
                        </div>
                    </div>
                </div>
            </div>
