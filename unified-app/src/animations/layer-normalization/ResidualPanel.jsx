        ...
        <div className="p-8 h-full flex flex-col items-center overflow-y-auto">
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    <div className="flex items-center justify-between mb-2">
                        <div>
                            ...
                            <p className="text-xs text-slate-800">Skip connection (Add)</p>
                        </div>
                        <button
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                    <div className="flex items-center justify-between mb-2">
                        <div>
                            ...
                            <p className="text-xs text-slate-800">Normalize (Norm)</p>
                        </div>
                        <button
            ...
            <div className="bg-slate-800 p-8 rounded-xl border border-slate-700 w-full max-w-4xl">
                ...
                <div className="flex flex-col items-center gap-6">
                    ...
                    <ArrowRight className="rotate-90 text-slate-800" size={32} />
                    ...
                    {useResidual ? (
                        ...
                        <div className="bg-slate-600 px-8 py-4 rounded-xl text-slate-700 font-bold text-lg opacity-50">
                            (No Residual)
                        </div>
                    )}
                ...
                <div className="mt-8 pt-6 border-t border-slate-700">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <div className="text-slate-800">Weak</div>
                        ...
                        <div className="text-slate-800">Strong</div>
                    </div>
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-violet-500/50 w-full max-w-4xl mt-8">
                ...
                <p className="text-xs text-slate-800 mt-3 text-center">
