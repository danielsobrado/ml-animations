                ...
                {Array.from({ length: numExperts }).map((_, i) => {
                    ...
                    return (
                        <div key={i} className="flex items-center gap-2">
                            <span className="text-xs font-mono w-6 text-slate-700 dark:text-slate-500">E{i}</span>
                            ...
                            <span className="text-xs text-slate-700 dark:text-slate-500 w-8 text-right">{load}</span>
                        </div>
                    );
                })}
            </div>
