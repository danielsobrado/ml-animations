        ...
        <div className="p-8 h-full flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row gap-8 w-full max-w-6xl h-[500px]">
                ...
                <div className="w-full md:w-80 flex flex-col gap-6 bg-white p-6 rounded-xl shadow-lg border border-slate-200 z-10">
                    <h3 className="font-bold text-slate-700 dark:text-slate-500 uppercase text-xs mb-4">Navigate the Landscape</h3>
                    ...
                    <div className="mt-auto">
                        <p className="text-sm text-slate-700 dark:text-slate-500 mb-1">Current Cost (MSE)</p>
