    ...
    return (
        <div className="p-8 h-full flex flex-col items-center">
            <div className="max-w-3xl w-full text-center mb-8">
                <h2 className="text-3xl font-bold text-cyan-600 mb-4">The Dot Product</h2>
            ...
            <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
                ...
                <div className="flex-1 h-[500px] bg-slate-800 rounded-xl border-2 border-slate-700 relative">
                    ...
                    {/* Instructions */}
                    <div className="absolute bottom-4 left-4 bg-slate-900/80 backdrop-blur-sm px-4 py-2 rounded-lg text-xs text-slate-200">
                ...
                <div className="w-full lg:w-96 flex flex-col gap-6">
                    ...
                    <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                        <h3 className="font-bold text-slate-200 uppercase text-xs mb-4">Vector A (Cyan)</h3>
                        <div className="space-y-4">
                            <div>
                                <label className="flex justify-between text-sm mb-2">
                                    X: <span className="text-cyan-600 font-mono">{v1.x}</span>
                                </label>
                                <input
                            ...
                            <div>
                                <label className="flex justify-between text-sm mb-2">
                                    Y: <span className="text-cyan-600 font-mono">{v1.y}</span>
                                </label>
                                <input
                                    type="range" min="-200" max="200" step="10"
                                    value={v1.y}
                    ...
                    <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                        <h3 className="font-bold text-slate-200 uppercase text-xs mb-4">Vector B (Pink)</h3>
                        <div className="space-y-4">
                            <div>
                                <label className="flex justify-between text-sm mb-2">
                                    X: <span className="text-pink-600 font-mono">{v2.x}</span>
                                </label>
                                <input
                                    type="range" min="-200" max="200" step="10"
                                    value={v2.x}
                            ...
                            <div>
                                <label className="flex justify-between text-sm mb-2">
                                    Y: <span className="text-pink-600 font-mono">{v2.y}</span>
                                </label>
                                <input
                                    type="range" min="-200" max="200" step="10"
                                    value={v2.y}
